# Harborline.Api.Foundation.Integrations
...
Implements [ADR 0013](../../docs/adrs/0013-foundation-integrations.md). Cross-cutting; consumed by every block that talks to a third-party (payments, messaging, captcha, signatures, background-check, etc.).
...
- [ADR 0013](../../docs/adrs/0013-foundation-integrations.md) — provider neutrality (Roslyn-enforced via the analyzer)
...
- [Harborline.Api.Blocks.Messaging](../blocks-messaging/README.md) — block-tier consumer of the messaging substrate
- [Harborline.Api.Blocks.PublicListings](../blocks-public-listings/README.md) — captcha + abuse-scorer consumer (Layers 1 + 4-5)
