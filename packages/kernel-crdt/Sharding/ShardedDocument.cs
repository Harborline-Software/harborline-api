...
namespace Harborline.Api.Kernel.Crdt.Sharding;
...
/// document's value encoding stays string/JSON-friendly. If the YDotNet adapter later
/// exposes native binary values, the encoding can change without changing the public surface.
/// </para>
/// <para>
