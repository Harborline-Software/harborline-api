...
/// Serializes via <see cref="Harborline.Api.Foundation.Crypto.CanonicalJson.Serialize"/>
...
/// <summary>Per A1.6 + A1.13 — Harborline's acknowledgment of how it relates to a given regime.</summary>
