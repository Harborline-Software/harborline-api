...
namespace Harborline.Api.Foundation.Taxonomy.Seeds;

/// <summary>
/// Harborline-shipped Authoritative-regime starter taxonomies, as authored in
...
public static class TaxonomyCorePackages
{
    ...
    /// </summary>
    public static TaxonomyCorePackage HarborlineSignatureScopes
    {
        get
        {
    ...
    /// </summary>
    public static TaxonomyCorePackage HarborlineLeasingJurisdictionRules
    {
        get
        {
            ...
            AddChild("us-fed.fcra.adverse-action-notice", "us-fed.fcra", "Adverse-Action Notice Requirement", "§615(a) mandatory notice when decision is based on a consumer report. Harborline ships the MandatoryFcraStatement (W#22 Phase 3).");
    ...
    /// (charter of 2026-04-30, a pre-Harborline intake artifact no longer in
    /// the repository set).
    /// </summary>
    public static TaxonomyCorePackage HarborlineVendorSpecialties
    {
        get
        {
