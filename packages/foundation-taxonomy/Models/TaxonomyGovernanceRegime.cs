...
public enum TaxonomyGovernanceRegime
{
    ...
    /// <summary>Harborline-shipped or compliance-source; only Harborline (the Authoritative actor) may publish new versions or mutate nodes. Pinned-version references only.</summary>
    Authoritative
}
