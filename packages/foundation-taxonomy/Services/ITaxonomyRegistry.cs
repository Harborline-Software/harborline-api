...
/// <list type="number">
/// <item><description><b>Authoritative regime guard:</b> only <see cref="ActorId.Harborline"/> may mutate Authoritative-regime definitions or their nodes.</description></item>
...
public interface ITaxonomyRegistry
{
    ...
    /// <summary>Creates a new taxonomy definition at the given version. Authoritative-regime definitions require <see cref="ActorId.Harborline"/> as <paramref name="owner"/>.</summary>
    ...
    /// <summary>
    /// Bulk-registers a Harborline-shipped Authoritative taxonomy + its full node
