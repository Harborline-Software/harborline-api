...
namespace Harborline.Api.Blocks.FinancialAp.Models;
...
///
/// <para>
/// <b>BillNumber is the vendor's own number</b>, not a Harborline-
...
public sealed record Bill : IMustHaveTenant
{
    ...
    /// <summary>
    /// The subsidiary-ledger account this bill belongs to (ADR 0120 PR-C / C-ARCH-2).
    /// Additive, nullable, back-compat: null for legacy bills that predate the
    ...
    /// 2+ leases → 2+ accounts, all same PartyId+AP-control). Migration backfill sets
