...
public sealed class InMemoryTaxRateLookup : ITaxRateLookup
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var addedEnvelope = DomainEventEnvelopeFactory.Build(
            ...
            occurredAt: candidate.CreatedAtUtc?.Value
                ?? throw new InvalidOperationException("A tax-rate write requires an act instant."),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var expiredEnvelope = DomainEventEnvelopeFactory.Build(
            ...
            occurredAt: newRate!.CreatedAtUtc?.Value
                ?? throw new InvalidOperationException("A tax-rate supersede requires an act instant."),
