...
public interface ITaxRateLookup
{
    ...
    ///         account of type <see cref="Harborline.Api.Blocks.FinancialLedger.Models.GLAccountType.Liability"/>
    ///         and subtype <see cref="Harborline.Api.Blocks.FinancialLedger.Models.AccountSubtype.TaxesPayable"/>.</item>
    /// </list>
...
public enum TaxRateValidationError
{
    ...
    /// <summary>The resolved account isn't <see cref="Harborline.Api.Blocks.FinancialLedger.Models.GLAccountType.Liability"/>.</summary>
    PayableAccountWrongType,
    /// <summary>The resolved account is Liability but not <see cref="Harborline.Api.Blocks.FinancialLedger.Models.AccountSubtype.TaxesPayable"/>.</summary>
