...
namespace Harborline.Api.Kernel.Events;
...
/// G3 of the 2026-04-18 discovery artifact (no longer in the repository
/// set) for the shipping contract.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class InMemoryEventBus : IEventBus
{
    ...
    /// <param name="verifier">Ed25519 verifier used on every <see cref="PublishAsync"/>. Resolved from DI via <c>AddHarborlineDecentralization</c> or manually-registered <see cref="Ed25519Verifier"/>.</param>
    /// <param name="timeProvider">The root kernel clock used for checkpoint writes.</param>
    ...
    public ValueTask AdvanceCheckpointAsync(string subscriberId, EventId lastProcessed, CancellationToken ct = default)
    {
        ...
        var cp = new EventCheckpoint(subscriberId, lastProcessed, _timeProvider.GetUtcNow());
