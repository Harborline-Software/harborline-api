...
/// The namespace <c>Harborline.Api.Kernel.Events</c> is preserved from the G1
/// reserved stub; the assembly that owns the type moved from
/// <c>Harborline.Api.Kernel</c> to <c>Harborline.Api.Kernel.EventBus</c> when the stub was
