...
/// </summary>
/// <remarks>
/// <b>DEPRECATED — use <see cref="Harborline.Api.Blocks.People.Foundation.Models.Party"/> instead.</b>
...
/// <c>Harborline.Api.Blocks.People.Foundation.Services.IPartyReadModel</c>
/// at read time rather than denormalizing.
/// </remarks>
[Obsolete("Use Harborline.Api.Blocks.People.Foundation.Models.Party instead. Resolve display names via IPartyReadModel. Do not add new references: this type is deleted once the last consumer has moved.")]
