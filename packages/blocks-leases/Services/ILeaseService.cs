...
public interface ILeaseService
{
    ...
    /// </summary>
    ValueTask<Lease> RecordPartySignatureAsync(LeaseId id, Harborline.Api.Blocks.People.Foundation.Models.PartyId party, SignatureEventId signatureEvent, ActorId actor, CancellationToken ct = default);
