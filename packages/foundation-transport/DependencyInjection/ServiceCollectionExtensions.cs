...
using Harborline.Api.Foundation.Transport.Relay;
using Harborline.Api.Kernel.Audit;

namespace Harborline.Api.Foundation.Transport.DependencyInjection;
...
public static class ServiceCollectionExtensions
{
    ...
    /// </remarks>
    public static IServiceCollection AddHarborlineTransport(this IServiceCollection services)
    {
        ArgumentNullException.ThrowIfNull(services);
        services.TryAddSingleton<ITransportSelector>(sp =>
            new DefaultTransportSelector(sp.GetServices<IPeerTransport>(), TimeProvider.System));
        return services;
    }
    ...
    /// </summary>
    public static IServiceCollection AddHarborlineTransport(this IServiceCollection services, TenantId tenantId)
    {
        ArgumentNullException.ThrowIfNull(services);
        if (tenantId == default)
        {
