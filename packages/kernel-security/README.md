# Harborline.Api.Kernel.Security

Role attestation and per-role symmetric-key distribution for the Harborline local-node architecture.
...
- **Harborline.Api.Foundation.LocalFirst** — supplies `IKeystore` for role-key caching.
