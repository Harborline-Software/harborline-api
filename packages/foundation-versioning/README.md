# Harborline.Api.Foundation.Versioning

Foundation-tier substrate for cross-version Harborline federation handshake — version vectors, compatibility rule engine, two-phase verdict-commit handshake, and audit emission with dedup.
...
Serialized via `Harborline.Api.Foundation.Crypto.CanonicalJson.Serialize` per A7.8:

```json
{"adapters":{"blazor":"0.9.0"},"channel":"Stable","instanceClass":"SelfHost","kernel":"1.3.0","plugins":{"Harborline.Api.Blocks.PublicListings":{"required":true,"version":"1.0.0"}},"schemaEpoch":7}
```
...
- [ADR 0049](../../docs/adrs/0049-audit-trail-substrate.md) — audit emission contract.

## See also

- [Harborline.Api.Foundation.Crypto.CanonicalJson](../foundation/Crypto/CanonicalJson.cs) — wire-format canonicalizer
- [Harborline.Api.Kernel.Audit](../kernel-audit/README.md) — audit substrate consumer
