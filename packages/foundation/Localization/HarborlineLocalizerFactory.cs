...
/// </remarks>
public sealed class HarborlineLocalizerFactory : IStringLocalizerFactory, IDisposable
{
    ...
    /// </summary>
    public HarborlineLocalizerFactory(IStringLocalizerFactory inner, string? resourcesRoot = null)
    {
