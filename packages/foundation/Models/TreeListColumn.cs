...
[Obsolete("Use HarborlineTreeListColumn child components instead.")]
...
/// <summary>
/// Event arguments for the <c>OnExpand</c> event on <c>HarborlineTreeList</c>.
...
/// <summary>
/// Event arguments for the <c>OnCollapse</c> event on <c>HarborlineTreeList</c>.
...
/// <summary>
/// Event arguments for the <c>OnRead</c> server-side data callback on <c>HarborlineTreeList</c>.
...
/// <summary>
/// Event arguments for the <c>OnRowDrop</c> row drag-and-drop callback on <c>HarborlineTreeList</c>.
/// </summary>
/// <typeparam name="TItem">The row data type.</typeparam>
