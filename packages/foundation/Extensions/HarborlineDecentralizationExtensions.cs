...
/// <summary>
/// DI extensions that register the Harborline Phase B decentralization primitives —
...
/// <see cref="HarborlineBuilder"/>.
/// </summary>
public static class HarborlineDecentralizationExtensions
{
    /// <summary>
    /// Registers Harborline decentralization primitives — crypto, capability graph,
    ...
    /// </para>
    /// </remarks>
    public static HarborlineBuilder AddHarborlineDecentralization(
        this HarborlineBuilder builder,
    ...
    internal sealed class DevKeyMaterialWarningService : IHostedService
    {
        ...
        {
            _logger.LogWarning(
                "DEV KEY MATERIAL ACTIVE: Harborline decentralization is running with EnableDevKeyMaterial = true. " +
