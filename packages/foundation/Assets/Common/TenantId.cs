...
/// <c>"__"</c> are reserved for Harborline system sentinels (currently
...
/// <b>Sentinels:</b>
/// <list type="bullet">
/// <item><description><see cref="System"/> — Harborline system actor (background
...
public readonly partial record struct TenantId
{
    ...
    /// for Harborline system sentinels and rejected with
    ...
    public TenantId(string value)
    {
        ...
        if (value.StartsWith("__", StringComparison.Ordinal))
        {
            throw new ArgumentException(
                ...
                + "The '__' prefix is reserved for Harborline system sentinels.",
                nameof(value));
        }
        Value = value;
    }
    ...
    /// <summary>
    /// True when this <see cref="TenantId"/> is a Harborline system sentinel
    ...
    /// <summary>
    /// Sentinel representing the Harborline system actor (background jobs,
