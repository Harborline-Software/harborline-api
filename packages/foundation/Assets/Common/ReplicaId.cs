...
/// <summary>
/// Opaque per-replica identifier — names the local Harborline replica
...
/// reserved for Harborline system sentinels (currently
...
public readonly record struct ReplicaId
{
    ...
    /// reserved for Harborline system sentinels and rejected with
    ...
    /// <summary>
    /// True when this <see cref="ReplicaId"/> is a Harborline system
    ...
    /// <summary>
    /// Sentinel representing the Harborline system replica — background
