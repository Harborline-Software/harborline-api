...
/// (and the Harborline-internal <c>IHarborlineLocalizer&lt;T&gt;</c> wrapper) against the
/// Harborline.Api.Blocks.Workflow shared resource bundle. The type itself carries no
