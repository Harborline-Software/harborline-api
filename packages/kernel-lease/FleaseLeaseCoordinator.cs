...
namespace Harborline.Api.Kernel.Lease;
...
public sealed class FleaseLeaseCoordinator : ILeaseCoordinator
{
    ...
    /// <param name="timeProvider">Root clock used for lease acts and expiry checks.</param>
    ...
    public async Task ReleaseAsync(Lease lease, CancellationToken ct)
    {
        ...
        var releaseMessage = new LeaseReleaseMessage(
            ...
            ReleasedAt: (ulong)_timeProvider.GetUtcNow().ToUnixTimeMilliseconds());
