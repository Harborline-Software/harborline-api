...
namespace Harborline.Api.Kernel.Lease.DependencyInjection;
...
public static class ServiceCollectionExtensions
{
    ...
    /// <c>AddHarborlineKernelSync()</c> first. The coordinator's node id and
    ...
    /// </remarks>
    public static IServiceCollection AddHarborlineKernelLease(
