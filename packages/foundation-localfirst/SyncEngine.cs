...
public sealed record SyncResult
{
    ...
    /// <summary>Number of conflicts encountered and automatically resolved.</summary>
    public int ConflictCount { get; init; }

    /// <summary>
    /// Number of conflicts surfaced for a decision (the ADR 0053 "Ask"
    /// outcome). Surfaced conflicts do not abort the cycle and are not errors.
    /// </summary>
    public int ConflictsSurfaced { get; init; }
...
public enum SyncEventKind
{
    ...
    /// <summary>Conflict surfaced for a decision; the cycle continues.</summary>
    ConflictSurfaced = 5,
}
