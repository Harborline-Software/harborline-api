...
/// Per cohort <c>Add*()</c> registration convention (one extension per module) (W#34 / W#35 / W#36 / W#39 /
/// W#40 / W#41).
/// </summary>
public static class WayfinderServiceExtensions
{
    ...
    /// <see cref="Harborline.Api.Kernel.Crdt.ICrdtEngine"/> and an
    /// <see cref="Harborline.Api.Foundation.Crypto.IOperationSigner"/>; the issuer
    ...
    /// </remarks>
    public static IServiceCollection AddHarborlineWayfinder(this IServiceCollection services)
    {
