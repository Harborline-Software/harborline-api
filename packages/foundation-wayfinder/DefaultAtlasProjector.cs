...
public sealed class DefaultAtlasProjector : IAtlasProjector
{
    ...
    /// call this during <c>AddHarborlineWayfinder()</c> wiring (Phase 3b's
    /// analyzer enforces that every <c>Add*()</c> registration call surface
    ...
    /// every locale a Harborline replica might run in.
    /// </summary>
