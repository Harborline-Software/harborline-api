// harborline-map.js — MapLibre GL JS adapter for HarborlineMap component.
...
/**
 * Translate a Harborline URL template to MapLibre's tiles array format.
 * Harborline uses {s}/{z}/{x}/{y}. MapLibre uses {z}/{x}/{y} and expects
