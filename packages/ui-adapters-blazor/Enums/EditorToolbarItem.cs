...
/// <summary>
/// Canonical MVP toolbar-item identifiers for the HarborlineEditor MVP surface
/// (<c>Components/Forms/Inputs/HarborlineEditor</c>).
///
/// <para>
/// This enum is intentionally a lean subset of the richer
/// <see cref="Harborline.Api.Foundation.Enums.EditorTool"/> enum used by the full
/// <c>Harborline.Api.UIAdapters.Blazor.Components.Editors.HarborlineEditor</c> component.
