...
// Harborline.Api.Foundation.Enums (packages/foundation/Enums/ComponentEnums.cs).
...
//
// Consumers should continue to import CalendarView via `Harborline.Api.Foundation.Enums`
