...
/// <summary>
/// Specifies the visual style used by <c>HarborlineGauge</c> — the polymorphic
/// gauge wrapper that dispatches to the appropriate underlying gauge renderer
/// (arc, radial, circular, or linear).
/// </summary>
/// <remarks>
/// ADR reference: Tier 3 W3-2 introduces <c>HarborlineGauge</c> as the canonical,
/// MVP-level entry point for gauge visuals. Existing gauge components
/// (<c>HarborlineArcGauge</c>, <c>HarborlineRadialGauge</c>, <c>HarborlineCircularGauge</c>,
/// <c>HarborlineLinearGauge</c>) remain available as low-level primitives.
/// </remarks>
