...
namespace Harborline.Api.UIAdapters.Blazor.Base;

/// <summary>
/// Base class for all Harborline components, providing shared infrastructure such as
...
public abstract class HarborlineComponentBase : ComponentBase, IDisposable
{
    ...
    [Inject] protected IHarborlineCssProvider CssProvider { get; set; } = default!;

    /// <summary>Gets the active icon provider, injected by the DI container.</summary>
    [Inject] protected IHarborlineIconProvider IconProvider { get; set; } = default!;

    /// <summary>Gets the active theme service, injected by the DI container.</summary>
    [Inject] protected IHarborlineThemeService ThemeService { get; set; } = default!;
    ...
    /// </summary>
    /// <param name="baseClass">The CSS class returned by the active <see cref="IHarborlineCssProvider"/>.</param>
    ...
    /// </summary>
    /// <param name="baseClasses">The CSS classes to combine, typically returned by the active <see cref="IHarborlineCssProvider"/>.</param>
    /// <returns>A single space-separated class string.</returns>
