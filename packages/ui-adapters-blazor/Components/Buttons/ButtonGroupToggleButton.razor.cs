...
/// <summary>
/// Toggleable child of <see cref="HarborlineButtonGroup"/>. Exposes per-child two-way
/// <c>Selected</c> binding and participates in container-level selection coordination
/// (single vs. multiple) via the <see cref="HarborlineButtonGroup.SelectionMode"/> cascade.
/// </summary>
public partial class ButtonGroupToggleButton : HarborlineComponentBase, IDisposable
{
    private bool _registered;

    [CascadingParameter] internal HarborlineButtonGroup? ParentGroup { get; set; }
    ...
    /// <c>@bind-Selected</c>. Container-level <see cref="HarborlineButtonGroup.SelectionMode"/>
    ...
    private async Task HandleClick(MouseEventArgs args)
    {
        ...
        {
            // Stand-alone fallback — behave like HarborlineToggleButton.
