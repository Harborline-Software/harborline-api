...
public partial class HarborlineGantt<TItem> : HarborlineComponentBase, IGanttViewHost, IAsyncDisposable
    where TItem : class
{
    ...
    private DotNetObjectReference<HarborlineGantt<TItem>>? _dotNetRef;
    ...
    /// <summary>Child content slot where HarborlineGanttDependencies is declared.</summary>
    ...
    internal HarborlineGanttDependencies<TItem>? _dependencies;

    internal void RegisterDependencies(HarborlineGanttDependencies<TItem> deps)
    {
        _dependencies = deps;
        _ = InvokeAsync(StateHasChanged);
    }

    internal void UnregisterDependencies(HarborlineGanttDependencies<TItem> deps)
    {
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            ...
            _jsModule = await JS.InvokeAsync<IJSObjectReference>(
                "import", HarborlineJsModuleLoader.Resolve("js/harborline-gantt.js"));
