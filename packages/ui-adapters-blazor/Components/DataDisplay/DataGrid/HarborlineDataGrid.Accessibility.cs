...
/// <summary>
/// Accessibility helpers for HarborlineDataGrid:
...
public partial class HarborlineDataGrid<TItem>
{
    ...
    /// scrolling the page.
    /// </summary>
    internal async Task OnHeaderKeyDown(HarborlineGridColumn<TItem> column, bool isSortable, KeyboardEventArgs e)
    {
    ...
    private Task AnnounceSortStateAsync(HarborlineGridColumn<TItem> column)
    {
    ...
    /// </summary>
    internal async Task MoveColumnLeft(HarborlineGridColumn<TItem> column)
    {
    ...
    /// </summary>
    internal async Task MoveColumnRight(HarborlineGridColumn<TItem> column)
    {
        var oldIndex = _columns.IndexOf(column);
    ...
    private async Task MoveColumnAsync(int oldIndex, int newIndex, HarborlineGridColumn<TItem> column)
    {
