...
/// <summary>
/// Row, cell, and fragment rendering logic for HarborlineDataGrid.
/// </summary>
public partial class HarborlineDataGrid<TItem>
{
    ...
    private GridCellRenderEventArgs<TItem>? GetCellRenderArgs(HarborlineGridColumn<TItem> column, TItem item)
    {
