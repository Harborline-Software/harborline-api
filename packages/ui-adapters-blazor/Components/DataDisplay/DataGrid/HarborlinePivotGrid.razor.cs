using Harborline.Api.Foundation.Base;
using Harborline.Api.Foundation.Models;
using Microsoft.AspNetCore.Components;

namespace Harborline.Api.UIAdapters.Blazor.Components.DataDisplay;

public partial class HarborlinePivotGrid : IPivotGridFieldHost
{
    /// <summary>Data source for the pivot grid.</summary>
    [Parameter] public IEnumerable<object>? Data { get; set; }

    /// <summary>
    /// POCO-based row field definitions. Prefer HarborlinePivotGridRowField child components instead.
    /// When both child fields and this parameter are provided, child fields take precedence.
    /// </summary>
    [Obsolete("Use HarborlinePivotGridRowField child components instead.")]
    [Parameter] public List<PivotGridField> RowFields { get; set; } = new();

    /// <summary>
    /// POCO-based column field definitions. Prefer HarborlinePivotGridColumnField child components instead.
    /// When both child fields and this parameter are provided, child fields take precedence.
    /// </summary>
    [Obsolete("Use HarborlinePivotGridColumnField child components instead.")]
    [Parameter] public List<PivotGridField> ColumnFields { get; set; } = new();

    /// <summary>
    /// POCO-based measure field definitions. Prefer HarborlinePivotGridMeasureField child components instead.
    /// When both child fields and this parameter are provided, child fields take precedence.
    /// </summary>
    [Obsolete("Use HarborlinePivotGridMeasureField child components instead.")]
    ...
    /// <summary>Child content that accepts HarborlinePivotGridRowField, HarborlinePivotGridColumnField, and HarborlinePivotGridMeasureField components.</summary>
    ...
    private readonly List<HarborlinePivotGridRowField> _registeredRowFields = new();
    private readonly List<HarborlinePivotGridColumnField> _registeredColumnFields = new();
    private readonly List<HarborlinePivotGridMeasureField> _registeredMeasureFields = new();

    void IPivotGridFieldHost.RegisterRowField(HarborlinePivotGridRowField field)
    {
    ...
    void IPivotGridFieldHost.UnregisterRowField(HarborlinePivotGridRowField field)
    {
    ...
    void IPivotGridFieldHost.RegisterColumnField(HarborlinePivotGridColumnField field)
    {
    ...
    void IPivotGridFieldHost.UnregisterColumnField(HarborlinePivotGridColumnField field)
    {
    ...
    void IPivotGridFieldHost.RegisterMeasureField(HarborlinePivotGridMeasureField field)
    {
    ...
    void IPivotGridFieldHost.UnregisterMeasureField(HarborlinePivotGridMeasureField field)
    {
