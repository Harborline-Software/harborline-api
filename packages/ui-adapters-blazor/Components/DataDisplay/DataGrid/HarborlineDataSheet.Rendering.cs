...
/// <summary>
/// RenderTreeBuilder helpers, row/cell class computation for HarborlineDataSheet.
/// </summary>
public partial class HarborlineDataSheet<TItem>
{
    ...
    private void RenderCellDisplay(RenderTreeBuilder builder, TItem row, HarborlineDataSheetColumn<TItem> column)
    {
    ...
    private void RenderCellEditor(RenderTreeBuilder builder, TItem row, HarborlineDataSheetColumn<TItem> column)
    {
        var value = GridReflectionHelper.GetValue(row, column.Field);
        var editRow = row;
