...
/// </summary>
public partial class HarborlineDataSheet<TItem> : IAsyncDisposable
{
    [Inject] private IJSRuntime JS { get; set; } = default!;

    private IJSObjectReference? _jsModule;
    private DotNetObjectReference<HarborlineDataSheet<TItem>>? _dotNetRef;
        ...
        if (firstRender)
        {
            ...
            try
            {
                _jsModule = await JS.InvokeAsync<IJSObjectReference>(
                    "import",
                    HarborlineJsModuleLoader.Resolve("js/harborline-datasheet.js"));
