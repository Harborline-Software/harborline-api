...
/// <summary>
/// Represents the current state of a <see cref="HarborlineDataGrid{TItem}"/>,
...
public class GridColumnState
{
    ...
    /// <summary>Whether the column exposes a column-menu trigger. Mirrors <see cref="HarborlineGridColumn{TItem}.ShowColumnMenu"/>.</summary>
    public bool ShowColumnMenu { get; set; }

    /// <summary>Whether the column appears in the column chooser. Mirrors <see cref="HarborlineGridColumn{TItem}.VisibleInColumnChooser"/>.</summary>
