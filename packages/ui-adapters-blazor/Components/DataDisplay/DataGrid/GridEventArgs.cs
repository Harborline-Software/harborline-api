...
/// <summary>
/// Event arguments for the <c>OnCellRender</c> callback on <see cref="HarborlineGridColumn{TItem}"/>.
/// </summary>
/// <typeparam name="TItem">The row data type.</typeparam>
...
/// <summary>Options for <see cref="HarborlineDataGrid{TItem}.ExportToExcelAsync(XlsxExportOptions?)"/>.</summary>
...
/// <summary>
/// Options controlling how <see cref="HarborlineDataGrid{TItem}.ExportToPdfAsync(PdfExportOptions?)"/>
/// behaves.
/// </summary>
