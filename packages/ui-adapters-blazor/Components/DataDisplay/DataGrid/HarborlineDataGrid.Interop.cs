...
/// </summary>
public partial class HarborlineDataGrid<TItem> : IAsyncDisposable
{
    [Inject] private IJSRuntime JS { get; set; } = default!;

    private IJSObjectReference? _jsModule;
    private DotNetObjectReference<HarborlineDataGrid<TItem>>? _dotNetRef;
    ...
    private async Task EnsureDataGridModuleAsync()
    {
        _dataGridModule ??= await JS.InvokeAsync<IJSObjectReference>(
            "import",
            HarborlineJsModuleLoader.Resolve("js/marilo-datagrid.js"));
    }
    ...
    /// Moves the column in <c>_columns</c>, re-sequences <see cref="HarborlineGridColumn{TItem}.OrderIndex"/>
...
/// <summary>
/// Event args raised by <see cref="HarborlineDataGrid{TItem}.OnColumnResized"/> (B2.8)
...
/// <summary>
/// Event args for <see cref="HarborlineDataGrid{TItem}.OnColumnReordering"/> (B3.5).
...
/// <summary>
/// Event args for <see cref="HarborlineDataGrid{TItem}.OnColumnReordered"/> (B3.5).
