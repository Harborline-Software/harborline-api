...
/// Mirrors the Harborline calendar spec for parity with the Telerik Blazor surface.
/// </summary>
public partial class HarborlineCalendar : HarborlineComponentBase
{
    ...
    /// <summary>Whether to render a button that navigates the month view to today.</summary>
    ...
    private Task GoToToday()       => NavigateToDisplayDate(DateTime.Today);
