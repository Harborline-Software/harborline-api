...
public sealed class SpreadsheetCell
{
    ...
    /// <summary>Renders the cell text bold.</summary>
    public bool Bold { get; set; }

    /// <summary>Renders the cell text italic.</summary>
    public bool Italic { get; set; }

    /// <summary>Renders the cell text underlined.</summary>
    public bool Underline { get; set; }

    /// <summary>Optional CSS text color.</summary>
    public string? TextColor { get; set; }

    /// <summary>Optional CSS cell background color.</summary>
...
/// <summary>A named worksheet: a display name plus its row grid. Used by <c>HarborlineSpreadsheet.Sheets</c>.</summary>
public sealed class SpreadsheetSheet
{
    /// <summary>Tab label for the sheet.</summary>
    public string Name { get; set; } = string.Empty;

    /// <summary>Rows in this sheet, ordered top-to-bottom.</summary>
    public List<SpreadsheetRow> Rows { get; set; } = new();
}
...
/// <summary>Event args for <c>HarborlineSpreadsheet.OnCellChanged</c>.</summary>
...
/// <summary>Event args emitted after a spreadsheet column width changes.</summary>
public sealed class SpreadsheetColumnWidthChangedEventArgs : EventArgs
{
    /// <summary>Zero-based column index.</summary>
    public int Column { get; init; }

    /// <summary>Previous width in pixels.</summary>
