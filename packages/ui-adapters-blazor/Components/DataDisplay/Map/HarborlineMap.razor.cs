using Harborline.Api.UIAdapters.Blazor.Components.DataDisplay.Map;
...
/// </remarks>
public partial class HarborlineMap : HarborlineComponentBase, IAsyncDisposable, IMapLayerHost
{
