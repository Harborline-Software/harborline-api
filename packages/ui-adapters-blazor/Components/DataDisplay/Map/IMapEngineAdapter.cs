...
namespace Harborline.Api.UIAdapters.Blazor.Components.DataDisplay.Map;

/// <summary>
/// Internal adapter interface mediating between HarborlineMap and a JS tile rendering engine.
...
internal interface IMapEngineAdapter : IAsyncDisposable
{
    ...
    /// </summary>
    Task InitializeAsync(ElementReference container, MapInitOptions options, DotNetObjectReference<HarborlineMap> dotNetRef);
