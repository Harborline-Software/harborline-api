...
/// <c>HarborlineFileUpload</c> / <c>HarborlineUpload</c> by passing the same id to that component's
...
/// via <see cref="OnDrop"/>.
/// </remarks>
public partial class HarborlineDropZone : HarborlineComponentBase
{
    // ── Parameters ─────────────────────────────────────────────────────────
