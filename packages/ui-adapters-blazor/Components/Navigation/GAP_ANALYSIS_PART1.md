...
## 1. HarborlineBreadcrumb.razor

**Spec expects:** `Data` property (collection), `CollapseMode`, `Width`, `Height`, `Size`, `ItemTemplate`, `SeparatorTemplate`, events, generic typed component (`HarborlineBreadcrumb<T>`)
...
## 2. HarborlineBreadcrumbItem.razor
...
## 4. HarborlineEnvironmentBadge.razor
...
|-----------|-------|--------|
| HarborlineBreadcrumb | Yes | **Major gaps** -- no data binding, templates, sizing, or events |
| HarborlineBreadcrumbItem | (part of above) | Missing icon support and text field |
| HarborlineContextMenu | Yes | **Major gaps** -- no data binding, selector, methods, or events |
| HarborlineEnvironmentBadge | No | Functional; consider parameter override |
| HarborlineMenu | Yes | **Moderate gaps** -- has data binding but missing hierarchy, show/hide, events |
| HarborlineMenuDivider | (part of menu) | Complete |
| HarborlineMenuItem | (part of menu) | Missing URL/link mode and sub-menus |
| HarborlineNavBar | No | Minimal but functional container |
| HarborlineNavItem | No | Good; consider icon/disabled support |
| HarborlineNavMenu | No | Minimal but functional container |
