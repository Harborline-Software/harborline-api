...
/// <summary>
/// Internal cascade sink used by <see cref="HarborlineUpload"/> to receive chunk-settings
/// registrations from the non-generic <see cref="HarborlineUploadChunkSettings"/> child component.
/// The interface decouples the child from any type parameters on the parent.
/// </summary>
internal interface IUploadChunkSettingsSink
{
    void RegisterChunkSettings(HarborlineUploadChunkSettings settings);
    void UnregisterChunkSettings(HarborlineUploadChunkSettings settings);
}

/// <summary>
/// Declarative child component for <see cref="HarborlineUpload"/> that configures chunk-upload
...
/// <example>
/// <code>
/// &lt;HarborlineUpload SaveUrl="/api/upload"&gt;
...
/// </code>
/// </example>
public class HarborlineUploadChunkSettings : ComponentBase, IDisposable
{
    [CascadingParameter] internal IUploadChunkSettingsSink? ParentSink { get; set; }

    /// <summary>
    /// Overrides the parent <see cref="HarborlineUpload.ChunkSize"/> when set.
