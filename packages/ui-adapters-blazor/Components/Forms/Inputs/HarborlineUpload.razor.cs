...
/// </summary>
public partial class HarborlineUpload : HarborlineComponentBase, IUploadChunkSettingsSink
{
    ...
    private HarborlineUploadChunkSettings? _chunkSettings;

    void IUploadChunkSettingsSink.RegisterChunkSettings(HarborlineUploadChunkSettings settings)
    {
        _chunkSettings = settings;
        InvokeAsync(StateHasChanged);
    }

    void IUploadChunkSettingsSink.UnregisterChunkSettings(HarborlineUploadChunkSettings settings)
    {
