...
/// <summary>
/// Event arguments supplied to <see cref="HarborlineMultiSelect{TItem, TValue}.OnRead"/>.
...
/// </summary>
/// <remarks>
/// When the callback is bound, <see cref="HarborlineMultiSelect{TItem, TValue}.Data"/> is ignored
