...
/// </remarks>
public partial class HarborlineFileUpload : HarborlineComponentBase, IAsyncDisposable
{
    ...
    /// Default is false - each file posts separately, matching the Harborline spec.
    /// </summary>
    ...
    /// <summary>
    /// When true, <see cref="HarborlineFileUpload"/> remembers the byte offset of a
