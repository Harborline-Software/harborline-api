...
/// <summary>
/// Internal cascade sink used by <see cref="HarborlineMultiSelect{TItem, TValue}"/> to
...
/// <summary>
/// Declarative child component that overrides general <see cref="HarborlineMultiSelect{TItem, TValue}"/>
...
/// <example>
/// <code>
/// &lt;HarborlineMultiSelect TItem="Country" TValue="int"&gt;
///     &lt;MultiSelectSettings AdaptiveMode="AdaptiveMode.Auto" /&gt;
/// &lt;/HarborlineMultiSelect&gt;
/// </code>
/// </example>
public class MultiSelectSettings : ComponentBase, IDisposable
{
    ...
    /// <summary>
    /// Overrides the parent <see cref="HarborlineMultiSelect{TItem, TValue}.AdaptiveMode"/>
...
/// <summary>
/// Declarative child component that overrides <see cref="HarborlineMultiSelect{TItem, TValue}"/>
...
public class MultiSelectPopupSettings : ComponentBase, IDisposable
{
    ...
    /// <summary>
    /// Overrides the parent <see cref="HarborlineMultiSelect{TItem, TValue}.PopupHeight"/>.
    /// Null means fall through to the parent parameter.
    /// </summary>
    [Parameter] public string? Height { get; set; }

    /// <summary>
    /// Overrides the parent <see cref="HarborlineMultiSelect{TItem, TValue}.PopupMaxHeight"/>.
    /// Null means fall through to the parent parameter.
    /// </summary>
    ...
    /// <summary>
    /// Overrides the parent <see cref="HarborlineMultiSelect{TItem, TValue}.PopupClass"/>.
    /// Null means fall through to the parent parameter.
    /// </summary>
