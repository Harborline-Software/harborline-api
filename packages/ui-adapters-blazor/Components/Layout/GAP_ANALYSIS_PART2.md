...
|-----------|------------|-----------|
| HarborlinePanel | **Critical** | Placeholder div; entire PanelBar feature set missing |
| HarborlineRow | **None** | No spec; appears complete |
| HarborlineSplitter | **Low** | Fully interactive N-pane splitter; only PersistKey and ResizeObserver remain |
| HarborlineStack | **Medium** | Missing Spacing, Width/Height, split alignment |
| HarborlineStep | **Medium** | Missing Icon, Disabled, validation |
| HarborlineStepper | **High** | Missing orientation, linear flow, clickable steps |
| HarborlineTabStrip | **Low** | Mostly complete; drag reorder not wired up |
