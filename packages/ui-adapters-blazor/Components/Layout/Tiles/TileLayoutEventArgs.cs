...
/// <summary>
/// Cancellable event arguments fired when a <c>HarborlineTile</c> is resized
/// inside a <c>HarborlineTileLayout</c>. Handlers may set <see cref="IsCancelled"/>
/// to veto the resize.
/// </summary>
...
/// <summary>
/// Cancellable event arguments fired when a <c>HarborlineTile</c> is reordered
/// inside a <c>HarborlineTileLayout</c>. Handlers may set <see cref="IsCancelled"/>
/// to veto the reorder.
/// </summary>
