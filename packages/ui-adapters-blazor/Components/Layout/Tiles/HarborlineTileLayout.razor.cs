...
namespace Harborline.Api.UIAdapters.Blazor.Components.Layout.Tiles;

/// <summary>
/// Canonical MVP tile-layout surface for Harborline Blazor. Arranges child
/// <see cref="HarborlineTile"/> elements on a CSS grid with configurable column
/// count, row height, and gap. Drag-to-reorder and drag-to-resize are
/// deferred (see component-mapping.json: status "partial").
/// </summary>
public partial class HarborlineTileLayout : HarborlineComponentBase
{
    ...
    private readonly List<HarborlineTile> _tiles = new();

    internal void RegisterTile(HarborlineTile tile)
    {
    ...
    internal void UnregisterTile(HarborlineTile tile) => _tiles.Remove(tile);
