...
/// <summary>
/// Shared base for declarative stepper children (<c>HarborlineStep</c> legacy and
/// <c>HarborlineStepperStep</c> spec-canonical). Owns registration with the parent
...
/// </summary>
public abstract class HarborlineStepBase : HarborlineComponentBase
{
    /// <summary>Parent stepper, resolved via cascading value.</summary>
    [CascadingParameter] protected HarborlineStepper? ParentStepper { get; set; }
