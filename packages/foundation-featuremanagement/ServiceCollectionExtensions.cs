...
namespace Harborline.Api.Foundation.FeatureManagement;

/// <summary>DI conveniences for <see cref="Harborline.Api.Foundation.FeatureManagement"/>.</summary>
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddHarborlineFeatureManagement(this IServiceCollection services)
    {
    ...
    /// <see cref="IFeatureProvider"/>. Requires <c>AddHarborlineWayfinder()</c>
    ...
    /// method calls <see cref="AddHarborlineFeatureManagement"/> first (which
    /// installs <see cref="InMemoryFeatureProvider"/>) and then re-registers
    /// <see cref="WayfinderFeatureProvider"/>, so the latter wins.
    /// </remarks>
    public static IServiceCollection AddHarborlineFeatureManagementWithWayfinder(
    ...
    /// <see cref="AddHarborlineFeatureManagement"/> was already called and only
