namespace Harborline.Api.Blocks.FinancialAr.Migration;
...
/// <param name="Customer">ERPNext <c>customer</c> — the ERPNext customer Name. The importer DOES NOT resolve this to a canonical <see cref="Harborline.Api.Blocks.People.Foundation.Models.PartyId"/>; the caller passes the resolved id at import time.</param>
...
/// <param name="Items">Line items — order preserved into <see cref="Harborline.Api.Blocks.FinancialAr.Models.InvoiceLine.LineNumber"/>.</param>
/// <param name="Status">ERPNext <c>status</c> — one of <c>"Draft"</c>, <c>"Submitted"</c>, <c>"Paid"</c>, <c>"Cancelled"</c>, etc. Mapped to canonical <see cref="Harborline.Api.Blocks.FinancialAr.Models.InvoiceStatus"/> by the importer.</param>
