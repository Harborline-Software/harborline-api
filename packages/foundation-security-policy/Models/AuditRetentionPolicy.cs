...
namespace Harborline.Api.Foundation.SecurityPolicy.Models;
...
/// for production use.
/// <para>
/// RIGHT-TO-ERASURE: Harborline audit records are append-only per ADR
...
/// Harborline does NOT expose a "delete audit record" endpoint. Whether
