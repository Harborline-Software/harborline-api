...
using Harborline.Api.Kernel.Audit.Retention;
using KernelPolicy = Harborline.Api.Kernel.Audit.Retention.AuditRetentionPolicy;

namespace Harborline.Api.Foundation.SecurityPolicy.Retention;
...
/// </para>
/// <list type="bullet">
///   <item>No purge surface on <see cref="Harborline.Api.Kernel.Audit.IAuditTrail"/> yet — enforcer reports counts only; no records are deleted regardless of <see cref="AuditRetentionEnforcementMode"/>.</item>
