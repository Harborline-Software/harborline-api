...
namespace Harborline.Api.Foundation.SecurityPolicy.Validation.Validators;
...
public sealed class SchemaValidator : ISecurityPolicyValidator
{
    ...
    /// <summary>Constructs the schema validator over the shared restricting-kind validator.</summary>
    public SchemaValidator(IRestrictingDefinitionKindValidator? restrictingKinds = null)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var retentionKindRefusal = _restrictingKinds.Validate(
            RestrictingDefinitionKindFamily.Retention,
            proposed.TenantId.ToString(),
            ar.JurisdictionPreset.ToString());
        if (retentionKindRefusal is not null)
            findings.Add(SecurityPolicyValidationFinding.Error(
                retentionKindRefusal.Code,
                retentionKindRefusal.Message,
