...
/// <remarks>
/// <para>
/// <b>Authorization:</b> callers supply a server-derived
/// <see cref="AuthorizationWriteContext"/>. The implementation decides the
/// financial-period override operation before mutation and uses the context
/// instant for every write in the act; it never consults <c>IUserContext</c>.
/// </para>
/// <para>
/// <b>Posting-service role requirement:</b> the injected
/// <c>IJournalPostingService</c> MUST be constructed against an
/// <c>IUserContext</c> carrying the explicit override operation (or
