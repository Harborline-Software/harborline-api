...
/// </para>
/// <para>
/// <b>Authorization warning:</b> callers MUST enforce the financial-period override operation
...
public interface IPeriodCloseService
{
    ...
    /// while callers with the explicit override operation may still
    /// post. Reversals remain allowed per Stage 02 §6.1 Phase 4.
    /// </summary>
    /// <param name="periodId">Period to soft-close.</param>
    /// <param name="authority">The already-gated act context whose instant stamps this transition.</param>
