...
public static class BundleManifestLoader
{
    ...
    /// <c>Harborline.Api.Foundation.Catalog</c>. The <paramref name="logicalName"/>
    ...
    /// <c>Harborline.Api.Foundation.Catalog</c>. Used for bundle manifests, the
    ...
    /// shipped with <c>Harborline.Api.Foundation.Catalog</c>.
    /// </summary>
