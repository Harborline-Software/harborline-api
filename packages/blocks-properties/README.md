# Harborline.Api.Blocks.Properties
...
- **`PropertiesEntityModule`** — `IHarborlineEntityModule` contribution (ADR 0015) registering `Property` + `PostalAddress` for persistence.
