# NOTICE — Harborline.Api.Blocks.Reports
...
- **Rent Roll v2 (PR 6):** ERPNext `rent_roll` + the Harborline v1 Rent Roll shipped in `@sunfish/contracts`. Harborline original.
...
This package depends only on first-party Harborline packages plus the standard Microsoft.Extensions DI surface:

- `Harborline.Api.Foundation` (first-party)
