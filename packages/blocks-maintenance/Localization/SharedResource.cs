namespace Harborline.Api.Blocks.Maintenance.Localization;
...
/// <see cref="Harborline.Api.Foundation.Localization.IHarborlineLocalizer{T}"/> binding
...
///     context (enforced by HARBORLINE_API_I18N_001).
