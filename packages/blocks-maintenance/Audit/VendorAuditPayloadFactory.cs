...
namespace Harborline.Api.Blocks.Maintenance.Audit;
...
internal static class VendorAuditPayloadFactory
{
    ...
    /// <summary>Body for <see cref="AuditEventType.VendorArchived"/> (ADR 0108 IArchivable).</summary>
    public static AuditPayload VendorArchived(VendorId vendor, ActorId actor) =>
        new(new Dictionary<string, object?>
        {
            ["vendor_id"] = vendor.Value,
            ["actor"] = actor.Value,
