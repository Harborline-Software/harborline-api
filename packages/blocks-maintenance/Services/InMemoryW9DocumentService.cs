...
public sealed class InMemoryW9DocumentService : IW9DocumentService
{
    ...
    public InMemoryW9DocumentService(
        IFieldEncryptor encryptor, IFieldDecryptor decryptor, TimeProvider timeProvider)
    {
    ...
    public Task<W9Document> VerifyAsync(W9DocumentId id, ActorId verifiedBy, TenantId tenant, CancellationToken ct = default)
    {
        ...
        var verified = existing with { VerifiedAt = _timeProvider.GetUtcNow(), VerifiedBy = verifiedBy };
