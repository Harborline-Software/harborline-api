...
namespace Harborline.Api.Kernel.Signatures.Services;
...
public sealed record SignatureCaptureRequest
{
    ...
    public required IReadOnlyList<Harborline.Api.Foundation.Taxonomy.Models.TaxonomyClassification> Scope { get; init; }

    /// <summary>Algorithm-agility container for the cryptographic signature bytes.</summary>
    public required Harborline.Api.Foundation.Crypto.SignatureEnvelope Envelope { get; init; }
