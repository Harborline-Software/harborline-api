...
public sealed class AttachmentOrphanReconciler
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var cutoff = new Instant(at.Value - _gracePeriod);
        ...
        foreach (var a in live)
        {
            ...
            if (await _attachments.SoftDeleteAsync(
                    a.Id, actor, reason ?? "orphan-gc", at, cancellationToken).ConfigureAwait(false))
                tombstoned++;
        }
        return tombstoned;
    }
