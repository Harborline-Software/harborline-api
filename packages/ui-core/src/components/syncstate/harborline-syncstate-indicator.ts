...
const LABELS_LONG: Record<SyncState, string> = {
  healthy: 'Last peer exchange succeeded; currentness not established',
  stale: 'Peer not reached recently; currentness not established',
  offline: 'Offline — saved locally',
  conflict: 'Review required — two versions diverged',
  quarantine: "Can't sync — open diagnostics",
};

@customElement('harborline-syncstate-indicator')
export class HarborlineSyncstateIndicator extends LitElement {
  static styles = css`
