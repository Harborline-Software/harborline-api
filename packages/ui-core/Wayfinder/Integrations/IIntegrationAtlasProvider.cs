...
/// <c>Harborline.Api.Foundation.Wayfinder</c>, which transitively
...
/// <c>Harborline.Api.Foundation.Assets.Common</c>), every issuance method
...
/// <c>Harborline.Api.Kernel.Audit.AuditEventType</c>. Audit
...
public interface IIntegrationAtlasProvider : IAtlasProvider<IntegrationAtlasView>
{
    ...
    /// <see cref="Harborline.Api.Foundation.Crypto.IDecryptCapability"/>
    /// via
    /// <see cref="Harborline.Api.Foundation.Crypto.IDecryptCapabilityProvider.AcquireAsync"/>
    /// with purpose
