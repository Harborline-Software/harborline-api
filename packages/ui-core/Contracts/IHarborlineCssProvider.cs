...
/// (e.g., Fluent UI, Material, Bootstrap) maps Harborline component states to its
...
/// </para>
/// <para>
/// The contract is intentionally large: each Harborline component has dedicated
...
/// </para>
/// </remarks>
public interface IHarborlineCssProvider
{
    // TODO(phase-2-followup): split this contract into one interface per category (buttons, forms, ...).
    // ── Layout ──────────────────────────────────────────────────────────
    ...
    /// <param name="iconName">The logical icon name (resolved through the active <see cref="IHarborlineIconProvider"/>).</param>
