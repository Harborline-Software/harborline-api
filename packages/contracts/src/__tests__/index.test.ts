...
describe('@harborline-software/api-contracts — property namespace', () => {
...
describe('@harborline-software/api-contracts — accounting namespace', () => {
...
describe('@harborline-software/api-contracts — tenant namespace', () => {
...
describe('@harborline-software/api-contracts — sync namespace', () => {
...
describe('@harborline-software/api-contracts — integrations namespace (ADR 0067)', () => {
...
describe('@harborline-software/api-contracts — system-requirements namespace (ADR 0063)', () => {
