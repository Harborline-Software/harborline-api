...
# Ticket 335 has not landed on origin/main, so this lane deliberately refuses rather than let a
# landing carry a stale quality baseline.  Its re-pin path will replace this refusal.
echo "land: quality baseline moved; refusing to land until ticket 335's baseline re-pin path is available." >&2
exit 1
