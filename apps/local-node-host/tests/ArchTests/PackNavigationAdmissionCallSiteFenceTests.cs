...
public sealed class PackNavigationAdmissionCallSiteFenceTests
{
    ...
    [
        ...
        new("apps/local-node-host/Health/PackWorkflowAdmissionAdapter.cs", "Harborline.Api.LocalNodeHost.Health.PackWorkflowAdmissionAdapter.Admit(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem],Harborline.Foundation.Assets.Common.TenantId): Harborline.Api.Foundation.Packs.Install.Admission.PackAdmissionResult", 53, "Harborline.Api.Foundation.Packs.Install.Admission.PackNavigationContentAdmission.Validate(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem],Harborline.Foundation.Assets.Common.TenantId,Harborline.Api.Foundation.Authorization.IRoleGateAdmission): System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackAdmissionRefusal]", "host admission", "the real host composes navigation admission beside workflow admission"),
        new("packages/foundation-packs/Install/Admission/IPackContentAdmission.cs", "Harborline.Api.Foundation.Packs.Install.Admission.WorkflowRefusingPackContentAdmission.Admit(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem],Harborline.Foundation.Assets.Common.TenantId): Harborline.Api.Foundation.Packs.Install.Admission.PackAdmissionResult", 86, "Harborline.Api.Foundation.Packs.Install.Admission.PackNavigationContentAdmission.Validate(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem],Harborline.Foundation.Assets.Common.TenantId,Harborline.Api.Foundation.Authorization.IRoleGateAdmission): System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackAdmissionRefusal]", "fail-closed default", "foundation installs still structurally admit navigation and refuse unwired role gates"),
        ...
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.FindNavigationCompositionRefusal(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.InstalledPack],System.String,System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", 1140, "Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclarationParser.Parse(System.String): Harborline.Api.Foundation.Packs.Navigation.PackNavigationParseResult", "installed inventory", "the latest installed declaration participates in semantic collision admission"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.FindNavigationCompositionRefusal(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.InstalledPack],System.String,System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", 1150, "Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclarationParser.Parse(System.String): Harborline.Api.Foundation.Packs.Navigation.PackNavigationParseResult", "candidate inventory", "the platform preload's ticket 176 navigation is admitted in the composed candidate inventory"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.FindNavigationCompositionRefusal(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.InstalledPack],System.String,System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", 1155, "Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclarationParser.FindCompositionRefusal(System.Collections.Generic.IEnumerable`1[Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclaration]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", "collision gate", "install refuses duplicate workspace, item, panel, and mode identities before commit"),
    ];
