...
public sealed class PackNavigationAdmissionCallSiteFenceTests
{
    ...
    [
        ...
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.FindNavigationCompositionRefusal(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.InstalledPack],System.String,System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", 1281, "Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclarationParser.Parse(System.String): Harborline.Api.Foundation.Packs.Navigation.PackNavigationParseResult", "installed inventory", "the latest installed declaration participates in semantic collision admission"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.FindNavigationCompositionRefusal(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.InstalledPack],System.String,System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", 1291, "Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclarationParser.Parse(System.String): Harborline.Api.Foundation.Packs.Navigation.PackNavigationParseResult", "candidate inventory", "the platform preload's ticket 176 navigation is admitted in the composed candidate inventory"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.FindNavigationCompositionRefusal(System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.InstalledPack],System.String,System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Packs.Install.Admission.PackComposedItem]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", 1296, "Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclarationParser.FindCompositionRefusal(System.Collections.Generic.IEnumerable`1[Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclaration]): Harborline.Api.Foundation.Packs.Navigation.PackNavigationRefusal", "collision gate", "install refuses duplicate workspace, item, panel, and mode identities before commit"),
    ];
