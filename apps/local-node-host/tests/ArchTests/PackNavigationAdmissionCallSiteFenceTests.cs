...
public sealed class PackNavigationAdmissionCallSiteFenceTests
{
    ...
    [
        new("apps/local-node-host/Health/PackNavigationRoutes.cs", "Harborline.Api.LocalNodeHost.Health.PackNavigationRoutes+PackNavigationContent.TryParse(System.String,Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclaration&,Harborline.Api.LocalNodeHost.Health.PackNavigationRoutes+ComposeError&): System.Boolean", 350, "Harborline.Api.Foundation.Packs.Navigation.PackNavigationDeclarationParser.Parse(System.String): Harborline.Api.Foundation.Packs.Navigation.PackNavigationParseResult", "read projection", "active immutable seeds are interpreted by the same parser that admitted them"),
