...
public sealed class AllowListVacuityArchTests
{
    ...
    [
        ...
        new("ValidatedBodyAdmissionArchTests", "OwnValidatedMinters",
            ValidatedBodyAdmissionArchTests.OwnValidatedMinterRows,
            ValidatedBodyAdmissionArchTests.DiscoveredOwnValidatedMinters),
