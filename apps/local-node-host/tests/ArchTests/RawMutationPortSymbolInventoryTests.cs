...
public sealed class RawMutationPortSymbolInventoryTests
{
    ...
    [
        ...
        new("apps/local-node-host/Data/Entities/NodeHierarchyCompositeCoordinator.cs", "Harborline.Api.LocalNodeHost.Data.Entities.NodeHierarchyCompositeCoordinator.ApplySplitAsync(Harborline.Api.LocalNodeHost.Data.Entities.NodeHierarchyCompositeCoordinator+CompositeAuthorization,Harborline.Api.Foundation.Assets.Common.EntityId,System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Assets.Hierarchy.SplitTarget],System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Assets.Common.EntityId],System.Collections.Generic.IReadOnlyDictionary`2[Harborline.Api.Foundation.Assets.Common.EntityId,Harborline.Api.Foundation.Assets.Common.EntityId],System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Assets.Hierarchy.EntityEdge],System.String,Harborline.Api.Foundation.Assets.Common.ActorId,Harborline.Api.Foundation.Assets.Common.TenantId,System.DateTimeOffset,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Hierarchy.SplitResult]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Common.SchemaId,System.Text.Json.JsonDocument,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "composite transaction", "split creates an admitted replacement"),
        ...
        new("apps/local-node-host/Data/Identity/AuthorizedGrantRevocationWriter.cs", "Harborline.Api.LocalNodeHost.Data.Identity.AuthorizedGrantRevocationWriter.RevokeAsync(Harborline.Api.Foundation.Assets.Common.TenantId,Harborline.Api.Blocks.AccessGrant.GrantId,Harborline.Api.Blocks.AccessGrant.GrantRevocation,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Blocks.AccessGrant.AccessGrant]", "Harborline.Api.Blocks.AccessGrant.IGrantStore.RevokeAsync(Harborline.Api.Foundation.Assets.Common.TenantId,Harborline.Api.Blocks.AccessGrant.GrantId,Harborline.Api.Blocks.AccessGrant.GrantRevocation,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Blocks.AccessGrant.AccessGrant]", 0, "decision-bearing adapter", "admin revocation passes the same allowed decision into its grant writer"),
        ...
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.ActivateCore(Harborline.Api.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],Harborline.Api.Foundation.Packs.Install.PackProjectionAuthority&): Harborline.Api.Foundation.Packs.Install.PackActivationOutcome", "Harborline.Api.Foundation.Packs.Install.IPackInstallMutationStore.RecordKeyOwnership(Harborline.Api.Foundation.Assets.Common.TenantId,System.String,System.String): System.Void", 0, "admitted coordinator", "activation persists its reviewed ownership choices"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.ActivateCore(Harborline.Api.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],Harborline.Api.Foundation.Packs.Install.PackProjectionAuthority&): Harborline.Api.Foundation.Packs.Install.PackActivationOutcome", "Harborline.Api.Foundation.Packs.Install.IPackProjectionAdmissionStore.ActivateAndRecordProjectionAdmission(Harborline.Api.Foundation.Assets.Common.TenantId,System.String,System.String,Harborline.Api.Foundation.Packs.Install.PackProjectionAdmission): System.Void", 0, "admitted coordinator", "activation atomically records its admission evidence"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.DeactivateCore(Harborline.Api.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,Harborline.Api.Foundation.Packs.Install.PackProjectionAuthority&): Harborline.Api.Foundation.Packs.Install.PackDeactivationOutcome", "Harborline.Api.Foundation.Packs.Install.IPackProjectionAdmissionStore.DeactivateAndRecordProjectionAdmission(Harborline.Api.Foundation.Assets.Common.TenantId,System.String,System.String,Harborline.Api.Foundation.Packs.Install.PackProjectionAdmission): System.Void", 0, "admitted coordinator", "deactivation atomically records its admission evidence"),
