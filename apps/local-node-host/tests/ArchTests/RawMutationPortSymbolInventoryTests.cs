...
public sealed class RawMutationPortSymbolInventoryTests
{
    ...
    [
        ...
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.CommitActivation(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],System.String,Harborline.Api.Foundation.Authorization.AuthorizationDecision): Harborline.Api.Foundation.Packs.Install.PackActivationOutcome", "Harborline.Api.Foundation.Packs.Install.IPackInstallMutationStore.RecordKeyOwnership(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String): System.Void", 0, "admitted coordinator", "activation persists its reviewed ownership choices"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.CommitActivation(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],System.String,Harborline.Api.Foundation.Authorization.AuthorizationDecision): Harborline.Api.Foundation.Packs.Install.PackActivationOutcome", "Harborline.Api.Foundation.Packs.Install.IPackProjectionAdmissionStore.ActivateAndRecordProjectionAdmission(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,Harborline.Api.Foundation.Packs.Install.PackProjectionAdmission): System.Void", 0, "admitted coordinator", "activation atomically records its admission evidence"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.CommitActivation(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],System.String,Harborline.Api.Foundation.Authorization.AuthorizationDecision): Harborline.Api.Foundation.Packs.Install.PackActivationOutcome", "Harborline.Api.Foundation.Packs.Install.IPackProjectionAdmissionStore.MarkProjectionCompleted(System.Guid): System.Void", 0, "admitted coordinator", "activation completes admitted projection inside the shared durable transaction before publication"),
