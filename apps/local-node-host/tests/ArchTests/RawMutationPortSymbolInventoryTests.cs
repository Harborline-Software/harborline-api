...
public sealed class RawMutationPortSymbolInventoryTests
{
    ...
    [
        ...
        new("apps/local-node-host/Data/Entities/NodeEntityWriter.cs", "Harborline.Api.LocalNodeHost.Data.Entities.NodeEntityWriter.CreateWithReceiptAsync(System.Text.Json.JsonDocument,System.String,Harborline.Api.Foundation.Authorization.AuthorizationWriteContext,System.Func`2[System.Threading.CancellationToken,System.Threading.Tasks.ValueTask`1[System.ValueTuple`2[Harborline.Api.Foundation.Assets.Common.SchemaId,Harborline.Api.Foundation.Assets.Entities.CreateOptions]]],System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Api.LocalNodeHost.Data.Entities.EntityWritten]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Entities.ValidatedRecordBody,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "admitted coordinator", "entity create through the ticket-366 token seam: the single allowed decision precedes bound-form preparation, admitted tenant/id checks and record validation; the ValidatedRecordBody and accepted-act audit receipt use that same decision"),
        ...
        new("apps/local-node-host/Data/Entities/NodeEntityWriter.cs", "Harborline.Api.LocalNodeHost.Data.Entities.NodeEntityWriter.UpdateAsync(Harborline.Api.Foundation.Assets.Common.EntityId,System.Text.Json.JsonDocument,Harborline.Api.Foundation.Assets.Entities.UpdateOptions,Harborline.Api.Foundation.Authorization.AuthorizationWriteContext,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Api.Foundation.Assets.Common.VersionId]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.UpdateAsync(Harborline.Api.Foundation.Assets.Common.EntityId,Harborline.Api.Foundation.Assets.Entities.ValidatedRecordBody,Harborline.Api.Foundation.Assets.Entities.UpdateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.VersionId]", 0, "admitted coordinator", "entity update through the ticket-366 token seam: the token was minted against the stored record's own schema from the same allowed decision"),
        ...
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.CommitActivationAsync(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],System.String,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Packs.Install.PackActivationOutcome]", "Harborline.Api.Foundation.Packs.Install.IPackInstallMutationStore.RecordKeyOwnership(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String): System.Void", 0, "admitted coordinator", "activation persists its reviewed ownership choices"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.CommitActivationAsync(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],System.String,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Packs.Install.PackActivationOutcome]", "Harborline.Api.Foundation.Packs.Install.IPackProjectionAdmissionStore.ActivateAndRecordProjectionAdmission(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,Harborline.Api.Foundation.Packs.Install.PackProjectionAdmission): System.Void", 0, "admitted coordinator", "activation atomically records its admission evidence"),
        // T-644: the configuration switch persists the prepared candidate's ownership selections inside the same
        // serializable transaction that moves the effective pointer, so they commit together or not at all.
        new("apps/local-node-host/Data/Configuration/ConfigurationActivationTarget.cs", "Harborline.Api.LocalNodeHost.Data.Configuration.ConfigurationActivationTarget.CompareAndSwapAsync(Harborline.Blocks.BuilderDefinitions.ConfigurationActivationRequest,Harborline.Api.Foundation.Authorization.AuthorizationWriteContext,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Blocks.BuilderDefinitions.ConfigurationActivationOutcome]", "Harborline.Api.LocalNodeHost.Data.Packs.DurablePackInstallStore.RecordKeyOwnership(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String): System.Void", 0, "admitted coordinator", "configuration activation commits its ownership selections with the effective pointer"),
        new("packages/foundation-packs/Install/PackInstaller.cs", "Harborline.Api.Foundation.Packs.Install.PackInstaller.CommitActivationAsync(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.String],System.String,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Packs.Install.PackActivationOutcome]", "Harborline.Api.Foundation.Packs.Install.IPackProjectionAdmissionStore.MarkProjectionCompleted(System.Guid): System.Void", 0, "admitted coordinator", "activation completes admitted projection inside the shared durable transaction before publication"),
    ...
    private static bool IsRawMutationTarget(MethodBase target, IReadOnlySet<Type> ports)
    {
        ...
        foreach (var port in ports.Where(port => port.IsAssignableFrom(declaring)))
        {
            ...
            // Ticket 366 slice 1: a store may implement a port member EXPLICITLY and keep a same-signature
            // member of its own for the assemblies the port's internal seam is visible to. That member is
            // not in the interface map, so match it by signature too — otherwise a direct concrete-type
            // raw write would leave the fence's inventory (the planted offender proves it does not).
            if (port.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)
                .Any(declared => declared.Name == method.Name && SameParameters(declared, method)))
                return true;
        }
        return false;
    }

    private static bool SameParameters(MethodInfo left, MethodInfo right)
    {
        var a = left.GetParameters();
        var b = right.GetParameters();
        return a.Length == b.Length
            && a.Zip(b).All(pair => pair.First.ParameterType == pair.Second.ParameterType);
    }
