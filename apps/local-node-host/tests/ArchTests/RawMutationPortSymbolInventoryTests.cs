...
public sealed class RawMutationPortSymbolInventoryTests
{
    ...
    [
        ...
        new("apps/local-node-host/Data/Entities/NodeEntityWriter.cs", "Harborline.Api.LocalNodeHost.Data.Entities.NodeEntityWriter.CreateAsync(Harborline.Api.Foundation.Assets.Common.SchemaId,System.Text.Json.JsonDocument,Harborline.Api.Foundation.Assets.Entities.CreateOptions,Harborline.Api.Foundation.Authorization.AuthorizationWriteContext,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Api.Foundation.Assets.Common.EntityId]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Entities.ValidatedBody,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "admitted coordinator", "entity create after the carried decision is allowed"),
        ...
        new("apps/local-node-host/Data/Entities/NodeEntityWriter.cs", "Harborline.Api.LocalNodeHost.Data.Entities.NodeEntityWriter.UpdateAsync(Harborline.Api.Foundation.Assets.Common.EntityId,System.Text.Json.JsonDocument,Harborline.Api.Foundation.Assets.Entities.UpdateOptions,Harborline.Api.Foundation.Authorization.AuthorizationWriteContext,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Api.Foundation.Assets.Common.VersionId]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.UpdateAsync(Harborline.Api.Foundation.Assets.Common.EntityId,Harborline.Api.Foundation.Assets.Entities.ValidatedBody,Harborline.Api.Foundation.Assets.Entities.UpdateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.VersionId]", 0, "admitted coordinator", "entity update after the carried decision is allowed"),
        new("apps/local-node-host/Data/Entities/NodeHierarchyCompositeCoordinator.cs", "Harborline.Api.LocalNodeHost.Data.Entities.NodeHierarchyCompositeCoordinator+<>c__DisplayClass10_0.<ReparentAsync>b__0(System.Threading.CancellationToken): System.Threading.Tasks.Task`1[System.Boolean]", "Harborline.Api.Foundation.Assets.Hierarchy.IHierarchyMutationStore.InvalidateEdgeAsync(System.Int64,System.DateTimeOffset,System.Threading.CancellationToken): System.Threading.Tasks.Task", 0, "composite transaction", "reparent invalidates the old edge inside the completely admitted unit of work"),
        ...
        new("packages/blocks-workflow/src/durable/AuthorizedWorkflowDefinitionLifecycle.cs", "Harborline.Api.Blocks.Workflow.Durable.AuthorizedWorkflowDefinitionLifecycle+EntityWriterBackend.RegisterAsync(Harborline.Api.Blocks.Workflow.Durable.WorkflowDefinition,System.Text.Json.JsonElement,Harborline.Api.Blocks.Workflow.Durable.WorkflowDefinitionRegistrationOptions,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Api.Blocks.Workflow.Durable.WorkflowDefinitionRecord]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Entities.ValidatedBody,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "persistence adapter", "authorized workflow lifecycle owns its entity persistence backend"),
        new("packages/foundation-forms-engine/IAuthorizedFormEntityWriter.cs", "Harborline.Api.Foundation.Forms.Engine.AuthorizedFormEntityWriter.CreateAsync(Harborline.Api.Foundation.Forms.Models.FormDefinitionId,Harborline.Api.Foundation.Assets.Common.SchemaId,System.Text.Json.JsonDocument,Harborline.Api.Foundation.Assets.Entities.CreateOptions,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Entities.ValidatedBody,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "decision-bearing adapter", "form engine passes the same allowed decision into its writer"),
        new("packages/foundation-forms/AuthorizedFormDefinitionLifecycle.cs", "Harborline.Api.Foundation.Forms.AuthorizedFormDefinitionLifecycle+EntityWriterBackend.RegisterAsync(Harborline.Api.Foundation.Forms.Models.FormDefinition,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Api.Foundation.Forms.Models.FormDefinition]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Entities.ValidatedBody,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "persistence adapter", "authorized form lifecycle owns its entity persistence backend"),
        ...
        new("packages/foundation/Assets/Entities/IEntityStore.cs", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateBatchAsync(System.Collections.Generic.IEnumerable`1[Harborline.Api.Foundation.Assets.Entities.EntityDraft],System.Threading.CancellationToken): System.Threading.Tasks.Task`1[System.Collections.Generic.IReadOnlyList`1[Harborline.Api.Foundation.Assets.Common.EntityId]]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Entities.ValidatedBody,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "raw port implementation", "default batch implementation delegates to the same raw port"),
        new("packages/foundation/Definitions/EntityStoreDefinitionLifecycle.cs", "Harborline.Api.Foundation.Definitions.EntityStoreDefinitionLifecycle`1[!0].TransitionAsync(!0,Harborline.Api.Foundation.Definitions.DefinitionCoordinates,Harborline.Api.Foundation.Definitions.DefinitionLifecycleStatus,System.Collections.Generic.IReadOnlyCollection`1[Harborline.Api.Foundation.Definitions.DefinitionLifecycleStatus],System.DateTimeOffset,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[!0]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.UpdateAsync(Harborline.Api.Foundation.Assets.Common.EntityId,Harborline.Api.Foundation.Assets.Entities.ValidatedBody,Harborline.Api.Foundation.Assets.Entities.UpdateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.VersionId]", 0, "persistence adapter", "definition lifecycle persists its admitted transition"),
    ];
        ...
        IGrantStore grants)
    {
        public Task<EntityId> Entity(EntityDraft draft, CancellationToken cancellationToken) =>
            entities.CreateAsync(draft.Body, draft.Options, cancellationToken);
