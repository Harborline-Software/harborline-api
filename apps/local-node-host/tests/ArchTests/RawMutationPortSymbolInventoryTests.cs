...
public sealed class RawMutationPortSymbolInventoryTests
{
    ...
    [
        ...
        new("apps/local-node-host/Data/Entities/NodeEntityWriter.cs", "Harborline.Api.LocalNodeHost.Data.Entities.NodeEntityWriter.CreateWithReceiptAsync(Harborline.Api.Foundation.Assets.Common.SchemaId,System.Text.Json.JsonDocument,Harborline.Api.Foundation.Assets.Entities.CreateOptions,Harborline.Api.Foundation.Authorization.AuthorizationWriteContext,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[Harborline.Api.LocalNodeHost.Data.Entities.EntityWritten]", "Harborline.Api.Foundation.Assets.Entities.IEntityMutationStore.CreateAsync(Harborline.Api.Foundation.Assets.Entities.ValidatedRecordBody,Harborline.Api.Foundation.Assets.Entities.CreateOptions,System.Threading.CancellationToken): System.Threading.Tasks.Task`1[Harborline.Api.Foundation.Assets.Common.EntityId]", 0, "admitted coordinator", "entity create through the ticket-366 token seam: the ValidatedRecordBody it passes was minted from the same allowed decision after the record validator ran; the receipt returns that same decision's accepted-act audit id"),
