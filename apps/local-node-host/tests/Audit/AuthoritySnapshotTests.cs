...
public sealed class AuthoritySnapshotTests
{
        ...
        IEnumerable<AuditAppendCallSite> discovered)
    {
        ...
        string[] allowed =
        {
            ...
            "apps/local-node-host/Health/AuthorizationRefusalAudit.cs|Harborline.Api.LocalNodeHost.Health.AuthorizationRefusalAudit.RecordCoreAsync(Harborline.Api.Foundation.Authorization.AuthorizationRefusal,System.String,Harborline.Api.Foundation.Assets.Common.ActorId,Harborline.Foundation.Assets.Common.TenantId,System.DateTimeOffset,Harborline.Api.Foundation.Authorization.AuthorizationDecision,Harborline.Api.Kernel.Audit.AuditEventType,System.Boolean,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[System.Nullable`1[System.Guid]]|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            ...
            "packages/blocks-financial-ap/Services/InMemoryBillRepository.cs|Harborline.Api.Blocks.FinancialAp.Services.InMemoryBillRepository.EmitTenantBoundaryViolationAsync(System.String,Harborline.Foundation.Assets.Common.TenantId,Harborline.Foundation.Assets.Common.TenantId,System.Nullable`1[System.DateTimeOffset],System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            "packages/blocks-financial-ar/Services/InMemoryInvoiceRepository.cs|Harborline.Api.Blocks.FinancialAr.Services.InMemoryInvoiceRepository.EmitTenantBoundaryViolationAsync(System.String,Harborline.Foundation.Assets.Common.TenantId,Harborline.Foundation.Assets.Common.TenantId,System.Nullable`1[System.DateTimeOffset],System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            "packages/blocks-financial-ledger/Services/IJournalStore.cs|Harborline.Api.Blocks.FinancialLedger.Services.InMemoryJournalStore.EmitTenantBoundaryViolationAsync(System.String,Harborline.Foundation.Assets.Common.TenantId,Harborline.Foundation.Assets.Common.TenantId,System.DateTimeOffset,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            "packages/blocks-financial-payments/Services/InMemoryPaymentApplicationRepository.cs|Harborline.Api.Blocks.FinancialPayments.Services.InMemoryPaymentApplicationRepository.EmitTenantBoundaryViolationAsync(System.String,Harborline.Foundation.Assets.Common.TenantId,Harborline.Foundation.Assets.Common.TenantId,System.Nullable`1[System.DateTimeOffset],System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            "packages/blocks-financial-payments/Services/InMemoryPaymentRepository.cs|Harborline.Api.Blocks.FinancialPayments.Services.InMemoryPaymentRepository.EmitTenantBoundaryViolationAsync(System.String,Harborline.Foundation.Assets.Common.TenantId,Harborline.Foundation.Assets.Common.TenantId,System.Nullable`1[System.DateTimeOffset],System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            ...
            "packages/foundation-packs/Install/PackInstaller.cs|Harborline.Api.Foundation.Packs.Install.PackInstaller.AuditPreDecisionRefusal(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.String): System.Void|Harborline.Api.Foundation.Packs.Install.Audit.IPackInstallAudit.Append(Harborline.Api.Foundation.Packs.Install.Audit.PackInstallAuditEntry): System.Void|0",
            ...
            "packages/foundation-taxonomy/Services/InMemoryTaxonomyRegistry.cs|Harborline.Api.Foundation.Taxonomy.Services.InMemoryTaxonomyRegistry.EmitAsync(Harborline.Foundation.Assets.Common.TenantId,Harborline.Api.Kernel.Audit.AuditEventType,Harborline.Api.Kernel.Audit.AuditPayload,System.DateTimeOffset,System.Threading.CancellationToken): System.Threading.Tasks.Task|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            ...
            "packages/foundation-wayfinder/DefaultOodWatchService.cs|Harborline.Api.Foundation.Wayfinder.DefaultOodWatchService.EmitAuditAsync(Harborline.Api.Kernel.Audit.AuditEventType,Harborline.Foundation.Assets.Common.TenantId,Harborline.Api.Foundation.Wayfinder.OodWatchId,Harborline.Api.Kernel.Audit.AuditPayload,System.DateTimeOffset,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|Harborline.Api.Kernel.Audit.IAuditTrail.AppendAsync(Harborline.Api.Kernel.Audit.AuditRecord,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
    ...
    private static void AssertAuthorizedAppendInventory(IEnumerable<AuditAppendCallSite> discovered)
    {
        string[] allowed =
        {
            // Ticket 331 slice 2: the ONE accepted-act sink. Every accepted act -- the narrowed binding
            // (slice 1) and the accepted record write -- is recorded here against the decision that
            // permitted it and nothing else, so the route has no append of its own to get wrong.
            "apps/local-node-host/Health/AuthorizedActAudit.cs|Harborline.Api.LocalNodeHost.Health.AuthorizedActAudit.RecordAsync(Harborline.Api.Kernel.Audit.AuditEventType,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Collections.Generic.IReadOnlyDictionary`2[System.String,System.Object],System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[System.Nullable`1[System.Guid]]|Harborline.Api.Kernel.Audit.IAuthorizedAuditTrail.AppendAuthorizedAsync(Harborline.Api.Kernel.Audit.AuditRecord,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Threading.CancellationToken,Harborline.Api.Foundation.Authorization.SeparationOfDuty.SeparationOfDutyDecision): System.Threading.Tasks.ValueTask|0",
            // Ticket 331: a decided refusal stores the denied evidence, with no new gate decision.
            "apps/local-node-host/Health/AuthorizationRefusalAudit.cs|Harborline.Api.LocalNodeHost.Health.AuthorizationRefusalAudit.RecordCoreAsync(Harborline.Api.Foundation.Authorization.AuthorizationRefusal,System.String,Harborline.Api.Foundation.Assets.Common.ActorId,Harborline.Foundation.Assets.Common.TenantId,System.DateTimeOffset,Harborline.Api.Foundation.Authorization.AuthorizationDecision,Harborline.Api.Kernel.Audit.AuditEventType,System.Boolean,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask`1[System.Nullable`1[System.Guid]]|Harborline.Api.Kernel.Audit.IRefusedAuditTrail.AppendRefusedAsync(Harborline.Api.Kernel.Audit.AuditRecord,Harborline.Api.Foundation.Authorization.AuthorizationDecision,System.Threading.CancellationToken): System.Threading.Tasks.ValueTask|0",
            // Ticket 208 slice 4: Post-admission narrowing refusals carry the same caller guard decision; no second decision.
            "packages/foundation-packs/Install/PackInstaller.cs|Harborline.Api.Foundation.Packs.Install.PackInstaller.AuditNarrowingRefusal(Harborline.Foundation.Assets.Common.TenantId,System.String,System.String,System.DateTimeOffset,System.String,System.String,System.String,Harborline.Api.Foundation.Authorization.AuthorizationDecision): Harborline.Api.Foundation.Packs.Install.PackNarrowingOutcome|Harborline.Api.Foundation.Packs.Install.Audit.IPackInstallAudit.AppendAuthorized(Harborline.Api.Foundation.Packs.Install.Audit.PackInstallAuditEntry,Harborline.Api.Foundation.Authorization.AuthorizationDecision): System.Void|0",
