    ...
    [property: JsonPropertyName("version")] int Version)
{
    ...
    public static AccountingPeriodWire From(FiscalPeriod p) => new(
        ...
        Label:        p.Label,
        StartDate:    p.StartDate.ToString("O", System.Globalization.CultureInfo.InvariantCulture),
        EndDate:      p.EndDate.ToString("O", System.Globalization.CultureInfo.InvariantCulture),
