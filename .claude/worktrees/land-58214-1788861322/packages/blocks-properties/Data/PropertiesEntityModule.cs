...
namespace Harborline.Api.Blocks.Properties.Data;

/// <summary>
/// <see cref="IHarborlineEntityModule"/> contribution for the properties block.
...
public sealed class PropertiesEntityModule : IHarborlineEntityModule
{
    ...
    public const string Key = "harborline.blocks.properties";
