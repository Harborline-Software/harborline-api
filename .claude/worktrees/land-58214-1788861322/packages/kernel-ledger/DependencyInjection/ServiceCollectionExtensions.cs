...
using Harborline.Api.Kernel.Ledger.CQRS;
using Harborline.Api.Kernel.Ledger.Periods;

namespace Harborline.Api.Kernel.Ledger.DependencyInjection;

/// <summary>
/// DI extensions for the Harborline kernel ledger subsystem (paper §12).
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    ///     .AddHarborlineKernelLease(localNodeId: "node-a")
    ///     .AddHarborlineKernelLedger();
    /// </code>
    /// </remarks>
    /// <param name="services">The service collection to add to.</param>
    /// <returns>The same <paramref name="services"/> instance for chaining.</returns>
    public static IServiceCollection AddHarborlineKernelLedger(this IServiceCollection services)
    {
