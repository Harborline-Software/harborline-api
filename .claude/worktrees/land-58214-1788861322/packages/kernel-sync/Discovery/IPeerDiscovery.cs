...
/// </summary>
/// <param name="NodeId">Advertising node identifier.</param>
/// <param name="Endpoint">Dialable transport endpoint.</param>
/// <param name="PublicKey">Team-scoped transport public key.</param>
/// <param name="TeamId">Team identifier used for coarse filtering.</param>
/// <param name="SchemaVersion">Supported sync schema version.</param>
/// <param name="Metadata">Free-form discovery metadata.</param>
/// <param name="RosterId">
/// Immutable roster-root identifier used to suppress parallel rosters that happen to reuse a team id.
/// </param>
