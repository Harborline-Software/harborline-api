...
import './harborline-dialog.js';
import '../button/harborline-button.js';

const meta: Meta = {
  title: 'Core/Dialog',
  component: 'harborline-dialog',
  parameters: {
    a11y: {
      harborline: {
...
export const Default: Story = {
  ...
  render: (args) => html`
    <harborline-dialog heading=${args.heading} ?open=${args.open}>
      <p>This action cannot be undone.</p>
      <harborline-button label="Cancel"></harborline-button>
      <harborline-button label="Delete"></harborline-button>
    </harborline-dialog>
  `,
};
