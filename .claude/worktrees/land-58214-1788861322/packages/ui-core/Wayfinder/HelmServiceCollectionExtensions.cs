...
namespace Harborline.Api.UICore.Wayfinder;

/// <summary>
/// DI registration for the Helm widget substrate per ADR 0066 §1.1 +
/// cohort <c>AddHarborlineX()</c> convention.
/// </summary>
public static class HelmServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddHarborlineHelm(this IServiceCollection services)
        => services.AddHarborlineHelm(_ => { });

    /// <summary>
    /// Register the Helm substrate with the supplied
    /// <see cref="HelmOptions"/> configuration.
    /// </summary>
    public static IServiceCollection AddHarborlineHelm(
