# TextBox — Interaction Contract (Redirect Stub)

- **Component:** TextBox
- **ADR 0017 family:** DataEntry
- **Contract type:** Interaction
- **Status:** Accepted (stub — superseded by TextField)
- **Superseded by:** [TextField.Interaction.md](./TextField.Interaction.md)
...
**Use [TextField](./TextField.Interaction.md) for all new code.** The
`TextBox` export will remain as a re-export alias of `TextField` for
backwards compatibility during the transition period.

See [TextField.Interaction.md](./TextField.Interaction.md) for the full contract.
