...
/// <summary>DI conveniences for <see cref="Harborline.Api.Foundation.Integrations"/>.</summary>
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddHarborlineIntegrations(this IServiceCollection services)
    {
