...
public enum SmsThreadTokenStrategy
{
    ...
    /// <summary>First line of the outbound SMS body contains the token (e.g., <c>[Ref: 7A2K…]</c>); inbound replies use the token when preserved by the mobile operator and fall through to fuzzy matching otherwise.</summary>
    InlineToken
}
