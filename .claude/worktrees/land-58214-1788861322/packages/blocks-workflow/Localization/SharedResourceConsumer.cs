...
namespace Harborline.Api.Blocks.Workflow.Localization;

/// <summary>
/// Bundle reference holder that closes the HARBORLINE_API_I18N_002 (LocUnused) loop for
...
/// <c>Harborline.Blocks.Workflow.csproj</c> can be removed without scaffolding an
...
/// <c>Harborline.Analyzers.LocUnused.UnusedResourceAnalyzer</c> matches.
/// <para>
