...
using Harborline.Api.Foundation.MissionSpace.Regulatory.Audit;
using Harborline.Api.Foundation.MissionSpace.Regulatory.Bridge;
using Harborline.Api.Kernel.Audit;

namespace Harborline.Api.Foundation.MissionSpace.Regulatory.DependencyInjection;
...
/// <remarks>
/// <para>
/// <b>Reader caution per A1.2:</b> Harborline does not provide legal advice;
