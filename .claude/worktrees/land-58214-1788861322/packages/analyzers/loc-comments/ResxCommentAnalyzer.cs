...
namespace Harborline.Api.Analyzers.LocComments
{
    /// <summary>
    /// HARBORLINE_API_I18N_001 — emits a warning for every .resx data entry missing a
    ...
    /// Harborline loc-cascade .props that does this automatically — Plan 2 Task 4.3 follow-up).
    /// </remarks>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public sealed class ResxCommentAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "HARBORLINE_API_I18N_001";
        ...
        internal static readonly DiagnosticDescriptor Rule = new(
            ...
            category: "Harborline.Api.I18n",
            // Plan 5 promotion: Error severity. Previously Warning, which only
            // failed the build because every Harborline project sets
            ...
            description:
                "Harborline API localization quality requires every .resx <data> entry to carry a <comment> that gives translators the context they need (audience, domain, surrounding UI). Missing or empty comments are the leading cause of mistranslation. See spec §8 + ADR 0034.",
            helpLinkUri: "https://github.com/Harborline-Software/Sunfish/blob/main/docs/diagnostic-codes.md#sunfish_i18n_001",
