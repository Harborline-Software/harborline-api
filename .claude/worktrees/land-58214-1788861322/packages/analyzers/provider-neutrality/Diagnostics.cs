...
internal static class Diagnostics
{
    ...
    public const string Category = "Harborline.Api.ProviderNeutrality";

    /// <summary>
    /// HARBORLINE_API_PROVNEUT_001 — vendor SDK namespace referenced from a non-providers
    /// package (a project under <c>packages/blocks-*/</c> or <c>packages/foundation-*/</c>).
    /// </summary>
    public const string ProviderNeutralityViolationId = "HARBORLINE_API_PROVNEUT_001";

    /// <summary>
    /// HARBORLINE_API_PROVNEUT_001 descriptor. Severity Error: ADR 0013 declares vendor-
