# Harborline.Api.Analyzers.LocUnused

Roslyn analyzer that emits **HARBORLINE_API_I18N_002** when a Harborline `.resx` data entry
...
policy, mirroring the HARBORLINE_API_I18N_001 cascade pattern.)
...
```xml
<ItemGroup>
  <PackageReference Include="Harborline.Api.Analyzers.LocUnused" Version="..." PrivateAssets="all" />
...
[*.cs]
dotnet_diagnostic.HARBORLINE_API_I18N_002.severity = none
```
