...
namespace Harborline.Api.Analyzers.LocUnused
{
    /// <summary>
    /// HARBORLINE_API_I18N_002 — emits a warning for every .resx data entry whose key has no
    ...
    /// Harborline project sets TreatWarningsAsErrors=true in Directory.Build.props — making
    /// the gate implicit on a build-wide flag. Promoted here to match Plan 5 §"CI gates"
    /// and mirror the HARBORLINE_API_I18N_001 cascade pattern (PR #75): the diagnostic now blocks
    ...
    {
        public const string DiagnosticId = "HARBORLINE_API_I18N_002";
        ...
        internal static readonly DiagnosticDescriptor Rule = new(
            ...
            // HARBORLINE_API_I18N_001 cascade (PR #75) so the diagnostic is Error
            ...
            helpLinkUri: "https://github.com/Harborline-Software/Sunfish/blob/main/packages/analyzers/loc-unused/README.md",
