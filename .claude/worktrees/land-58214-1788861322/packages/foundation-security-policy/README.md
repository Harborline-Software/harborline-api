# Harborline.Api.Foundation.SecurityPolicy
...
(`HARBORLINE_API_RETENTION_FLOOR_001`), and the Atlas UI surface (Phase 2)
...
- [ADR 0077](../../docs/adrs/0077-shared-design-system.md) — `ShipRole` source
- [ADR 0065](../../docs/adrs/0065-wayfinder-system-and-standing-order-contract.md) — Standing-Order issuance path
- [ADR 0049](../../docs/adrs/0049-audit-trail-substrate.md) — `IAuditTrail` + `AuditEventType` consumer
- [ADR 0046-A2](../../docs/adrs/0046-key-loss-recovery-scheme-phase-1.md) — `EncryptedField` future integration (Phase 3)
