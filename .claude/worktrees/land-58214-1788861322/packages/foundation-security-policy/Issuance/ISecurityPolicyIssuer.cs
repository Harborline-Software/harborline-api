...
/// ADR 0068 §3. Composes
/// <c>Harborline.Api.Foundation.Wayfinder.IStandingOrderIssuer</c> for the
...
/// <see cref="Harborline.Api.Kernel.Audit.AuditEventType"/> record from the
...
public interface ISecurityPolicyIssuer
{
    ...
    /// <see cref="Harborline.Api.Foundation.Ship.Common.ShipRole.Captain"/>
