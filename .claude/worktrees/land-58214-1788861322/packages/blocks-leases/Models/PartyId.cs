...
/// </summary>
/// <remarks>
/// <b>DEPRECATED — use <see cref="Harborline.Api.Blocks.People.Foundation.Models.PartyId"/> instead.</b>
...
/// consume the canonical type directly. This type is deleted once
/// the last consumer has moved; migrating them is not in scope here.
/// </remarks>
#pragma warning disable CS0618 // type-internal references to the obsolete PartyId
[Obsolete("Use Harborline.Api.Blocks.People.Foundation.Models.PartyId instead. Wire format is compatible; convert via implicit string operators. Do not add new references: this type is deleted once the last consumer has moved.")]
