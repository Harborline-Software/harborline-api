...
using Harborline.Api.Blocks.Leases.Audit;
using Harborline.Api.Blocks.Leases.Models;
using Harborline.Api.Blocks.Maintenance.Services;
using Harborline.Api.Foundation.Assets.Common;
using Harborline.Api.Foundation.Crypto;
using Harborline.Api.Kernel.Audit;
using Harborline.Api.Kernel.Signatures.Models;
...
public sealed class InMemoryLeaseService : ILeaseService
{
    ...
    public InMemoryLeaseService(TimeProvider timeProvider)
    {
    ...
    public InMemoryLeaseService(
        ...
        : this(auditTrail, signer, tenantId, documentVersionLog: null, timeProvider) { }
    ...
    /// <inheritdoc />
    public async ValueTask<Lease> RecordPartySignatureAsync(LeaseId id, Harborline.Api.Blocks.People.Foundation.Models.PartyId party, SignatureEventId signatureEvent, ActorId actor, CancellationToken ct = default)
    {
        ct.ThrowIfCancellationRequested();
        if (!_store.TryGetValue(id, out var lease))
        {
