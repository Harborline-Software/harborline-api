...
- **`LeaseListBlock.razor`** — read-display Razor component showing the lease list at the configured tenant.
...
- [ADR 0028](../../docs/adrs/0028-crdt-engine-selection.md) — Lease creation interface boundary (cross-block; consumed by `blocks-property-leasing-pipeline.LeaseOffer`)
...
- [Harborline.Api.Blocks.Properties](../blocks-properties/README.md) — `PropertyId` FK target
- [Harborline.Api.Blocks.PropertyLeasingPipeline](../blocks-property-leasing-pipeline/README.md) — upstream `LeaseOffer` producer
