...
/// Intermediate between HarborlinePopover (tooltip-like) and HarborlineDialog (full-screen modal).
/// </summary>
/// <remarks>
...
/// </remarks>
public partial class HarborlinePopup : HarborlineComponentBase, IAsyncDisposable
{
    // ── Fields ──────────────────────────────────────────────────────────

    private ElementReference _popupRef;
    private IJSObjectReference? _jsModule;
    private DotNetObjectReference<HarborlinePopup>? _dotNetRef;
    ...
    protected override void OnParametersSet()
    {
        ...
        if (FocusTrap && string.IsNullOrWhiteSpace(Title) && !_missingTitleWarned)
        {
            ...
            Console.Error.WriteLine(
                "[HarborlinePopup] FocusTrap=true requires a non-empty Title to satisfy WCAG 4.1.2 " +
