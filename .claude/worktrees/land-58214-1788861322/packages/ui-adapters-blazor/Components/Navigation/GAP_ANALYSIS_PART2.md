...
## 1. HarborlinePagination.razor vs Pager Spec

**Spec name:** `Pager` | **Our name:** `HarborlinePagination`
...
## 2. HarborlineTimeRangeSelector.razor -- No Spec
...
## 3. HarborlineToolbar.razor vs Toolbar Spec
...
- **Child component naming diverges:** Spec uses `ToolBarButton`, `ToolBarToggleButton`, `ToolBarButtonGroup`, `ToolBarSeparator`; we use `HarborlineToolbarButton`, `HarborlineToolbarGroup`, `HarborlineToolbarSeparator`, `HarborlineToolbarToggleButton`.

## 4. HarborlineToolbarButton.razor (part of Toolbar)
...
## 5. HarborlineToolbarGroup.razor (part of Toolbar)
...
## 6. HarborlineToolbarSeparator.razor (part of Toolbar)
...
## 7. HarborlineToolbarToggleButton.razor (part of Toolbar)

- **Missing `Icon` parameter:** Same gap as `HarborlineToolbarButton`.
...
## 8. HarborlineTreeItem.razor (part of TreeView)
...
## 9. HarborlineTreeView.razor vs TreeView Spec
