...
public partial class HarborlineTreeItem : HarborlineComponentBase
{
    [CascadingParameter] public HarborlineTreeView? TreeView { get; set; }
    ...
    /// When unset, derives from the cascaded <see cref="HarborlineTreeView"/> presence to
