...
/// <summary>
/// Cancellable payload fired by <see cref="HarborlineAIPrompt.OnPrompt"/>. The handler
...
/// <summary>
/// Cancellable payload fired by <see cref="HarborlineInlineAIPrompt.OnInline"/>.
/// </summary>
...
/// <summary>
/// Cancellable payload fired by <see cref="HarborlinePromptBox.OnSubmit"/>.
/// </summary>
...
/// <summary>Lifecycle state for a prompt-box attachment.</summary>
public enum PromptBoxAttachmentStatus
{
    Ready,
    Uploading,
    Error,
...
/// <summary>A host-owned attachment displayed by <see cref="HarborlinePromptBox"/>.</summary>
public sealed record PromptBoxAttachment(
    string Id,
    string Name,
    long? Size = null,
    string? ContentType = null,
    PromptBoxAttachmentStatus Status = PromptBoxAttachmentStatus.Ready,
    string? ValidationMessage = null);

/// <summary>Payload for the prompt box's unified action event.</summary>
public sealed class PromptBoxActionEventArgs
{
    /// <summary>The submitted prompt.</summary>
    public string Prompt { get; }

    /// <summary>Attachments present at submit time.</summary>
    public IReadOnlyList<PromptBoxAttachment> Attachments { get; }

    /// <summary>Creates an action payload.</summary>
    public PromptBoxActionEventArgs(string prompt, IReadOnlyList<PromptBoxAttachment>? attachments = null)
    {
        Prompt = prompt;
        Attachments = attachments ?? Array.Empty<PromptBoxAttachment>();
    }
}
