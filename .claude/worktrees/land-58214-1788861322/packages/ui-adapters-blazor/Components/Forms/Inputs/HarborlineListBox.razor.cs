...
/// <summary>
/// Controls the position of the <see cref="HarborlineListBox{TItem}"/> toolbar relative to the item list.
/// </summary>
...
public partial class HarborlineListBox<TItem> : HarborlineComponentBase
{
    // ---- Data & fields ----
    ...
    /// </summary>
    [Parameter] public HarborlineListBox<TItem>? ConnectedRef { get; set; }
    ...
    private static readonly Dictionary<string, WeakReference<HarborlineListBox<TItem>>> s_registry = new();
    ...
    private static HarborlineListBox<TItem>? s_currentDragSource;
    ...
    protected override void OnInitialized()
    {
        ...
        {
            s_registry[Id] = new WeakReference<HarborlineListBox<TItem>>(this);
        }
    }
    ...
    private HarborlineListBox<TItem>? ResolveConnected()
    {
