...
using Harborline.Api.Foundation.Models.DataSheet;
...
/// </summary>
public partial class HarborlineDataSheet<TItem> : HarborlineComponentBase
{
    // ── Internal state ─────────────────────────────────────────────────
    internal readonly List<HarborlineDataSheetColumn<TItem>> _columns = [];
    ...
    /// <summary>HarborlineDataSheetColumn definitions.</summary>
    ...
    internal void RegisterColumn(HarborlineDataSheetColumn<TItem> column)
    {
    ...
    internal void UnregisterColumn(HarborlineDataSheetColumn<TItem> column)
    {
    ...
    internal async Task AddRowAsync()
    {
        ...
        if (key != null)
        {
            ...
            {
                Original = Harborline.Api.Foundation.Helpers.GridReflectionHelper.DeepClone(newItem),
                Current = newItem,
                IsNewlyAdded = true
            };
            ...
            // Original snapshot (see HarborlineDataSheet.Data.cs:106). Without that
