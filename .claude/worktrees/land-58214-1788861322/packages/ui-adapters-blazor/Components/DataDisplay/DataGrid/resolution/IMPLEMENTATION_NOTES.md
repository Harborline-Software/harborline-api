# Implementation Notes: HarborlineDataGrid, HarborlineGridColumn, HarborlineGridToolbar
...
- `HarborlineDataGrid.razor` — Major expansion: 420 → ~520 lines. Added 15+ parameters, dual-mode data processing, row/cell render callbacks, checkbox selection, page-size dropdown
- `HarborlineGridColumn.razor` — Added `Visible`, `EditorTemplate`, `FooterTemplate`, `OnCellRender` parameters
- `HarborlineGridToolbar.razor` — Added ARIA attributes
