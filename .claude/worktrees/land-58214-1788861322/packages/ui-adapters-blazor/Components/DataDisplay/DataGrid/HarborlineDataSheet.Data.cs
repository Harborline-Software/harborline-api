...
/// <summary>
/// Dirty-state tracking, commit, reset, and validation logic for HarborlineDataSheet.
/// </summary>
public partial class HarborlineDataSheet<TItem>
{
    ...
    internal string? RunColumnValidation(HarborlineDataSheetColumn<TItem> column, TItem row)
    {
        // Required check
        if (column.Required)
        {
    ...
    /// as <see cref="HarborlineDataSheet{TItem}"/> row types.
    /// </para>
    /// <para>
