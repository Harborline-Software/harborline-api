...
using Harborline.Api.Foundation.Helpers;
...
/// <summary>
/// Active cell state, edit mode transitions, and keyboard handlers for HarborlineDataSheet.
/// </summary>
public partial class HarborlineDataSheet<TItem>
{
    // ── Active Cell State ──────────────────────────────────────────────
    ...
    private static object? GetDefaultValue(HarborlineDataSheetColumn<TItem> column)
    {
    ...
    private static (bool Success, object? Value, string? Error) TryParseCellValue(
        HarborlineDataSheetColumn<TItem> column, string text) => column.ColumnType switch
    {
    ...
    private static Type GetColumnClrType(HarborlineDataSheetColumn<TItem> column)
    {
    ...
    private static (bool Success, object? Value) ParseNumberForCell(
        HarborlineDataSheetColumn<TItem> column, string text)
    {
