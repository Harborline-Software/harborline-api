// using Harborline.Api.UIAdapters.Blazor.Components.DataGrid.Sizing; — removed: Sizing types now flat in DataDisplay namespace
using Harborline.Api.Foundation.Base;
using Harborline.Api.UIAdapters.Blazor.Base;
using Harborline.Api.Foundation.BusinessLogic.Enums;
...
public partial class HarborlineAllocationScheduler<TResource> : HarborlineComponentBase, IAsyncDisposable
{
    ...
    private DotNetObjectReference<HarborlineAllocationScheduler<TResource>>? _dotNetRef;
        ...
        if (firstRender)
        {
            ...
            try
            {
                _jsModule = await JSRuntime.InvokeAsync<IJSObjectReference>(
                    "import", HarborlineJsModuleLoader.Resolve("js/allocation-scheduler.js"));
