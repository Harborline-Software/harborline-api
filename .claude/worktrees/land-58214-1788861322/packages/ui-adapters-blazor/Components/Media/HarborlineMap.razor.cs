...
/// </list>
/// </remarks>
public partial class HarborlineMap : HarborlineComponentBase, IAsyncDisposable
{
    /// <summary>Well-known module path for the Leaflet-compatible JS engine.</summary>
    /// <remarks>Not yet shipped with the package — see <see cref="HarborlineMap"/> remarks.</remarks>
    public static readonly string JsModulePath = HarborlineJsModuleLoader.Resolve("js/map.js");
    ...
    private DotNetObjectReference<HarborlineMap>? _dotNetRef;
