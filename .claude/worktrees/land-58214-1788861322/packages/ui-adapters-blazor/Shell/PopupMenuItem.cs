...
/// <summary>Single row in a <see cref="HarborlineUserMenu"/>.</summary>
...
/// <summary>Single notification entry rendered in <see cref="HarborlineNotificationBell"/>.</summary>
