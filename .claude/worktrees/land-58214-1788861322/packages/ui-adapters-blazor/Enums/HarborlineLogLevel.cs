...
/// <summary>
/// Diagnostic verbosity for Harborline components rendered beneath a
/// <see cref="Components.Utility.HarborlineThemeProvider"/>. Cascaded to descendants
...
/// </summary>
public enum HarborlineLogLevel
{
