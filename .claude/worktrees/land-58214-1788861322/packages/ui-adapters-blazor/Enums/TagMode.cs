...
/// <see cref="Components.Forms.Inputs.HarborlineMultiSelect{TItem, TValue}"/>.
...
public enum TagMode
{
    ...
    /// replaced by <see cref="Components.Forms.Inputs.HarborlineMultiSelect{TItem, TValue}.SummaryTagTemplate"/>
    /// or <see cref="Components.Forms.Inputs.HarborlineMultiSelect{TItem, TValue}.ChipTemplate"/>.
    /// </summary>
    Single,
