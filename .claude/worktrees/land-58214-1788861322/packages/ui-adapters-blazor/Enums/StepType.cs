...
/// <summary>
/// Controls how <c>HarborlineStepper</c> renders each step on the rail. Mirrors the
/// Telerik/Harborline <c>StepperStepType</c> surface so spec samples port without edits.
/// </summary>
