...
/// <summary>
/// Blazor-side extensions over <see cref="IHarborlineIconProvider"/>.
/// </summary>
/// <remarks>
/// <see cref="IHarborlineIconProvider.GetIcon"/> returns a raw HTML string because the
...
public static class IconProviderExtensions
{
    ...
    public static MarkupString GetIconMarkup(
        this IHarborlineIconProvider provider,
        string name,
