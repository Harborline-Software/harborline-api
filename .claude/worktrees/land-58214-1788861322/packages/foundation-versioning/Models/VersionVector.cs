...
namespace Harborline.Api.Foundation.Versioning;

/// <summary>
/// Wire-format version vector exchanged at the Harborline federation handshake
...
/// <see cref="Harborline.Api.Foundation.Crypto.CanonicalJson"/>.
/// </para>
/// <para>
...
/// <param name="InstanceClass">Harborline-instance class (A6.2 rule 6 / A7.6 reduced enum).</param>
