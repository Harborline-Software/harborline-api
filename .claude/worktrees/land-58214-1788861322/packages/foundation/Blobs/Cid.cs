...
namespace Harborline.Api.Foundation.Blobs;
...
///
/// This is a minimal implementation of the IPFS CID spec — enough for Harborline to address blobs
...
/// until that's done, treat these CIDs as Harborline-internal identifiers that follow the CID v1
...
public readonly record struct Cid(string Value)
{
    ...
    /// <summary>Computes the CID of a byte sequence using the canonical Harborline format.</summary>
    ...
    /// to a Kubo daemon) back into Harborline's type system.
    /// </summary>
