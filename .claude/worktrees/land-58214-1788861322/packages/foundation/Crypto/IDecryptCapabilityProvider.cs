...
/// <c>Harborline.Api.UICore.Wayfinder.Integrations.IIntegrationAtlasProvider.ValidateProviderAsync</c>
...
/// <c>Harborline.Api.Foundation.Crypto</c> alongside
...
/// <c>AddHarborlineRecoveryCoordinator()</c>; the
/// <c>AddHarborlineIntegrationAtlas()</c> guard rejects host wiring
...
public interface IDecryptCapabilityProvider
{
    ...
    /// <c>Harborline.Api.UICore.Wayfinder.Integrations.IntegrationCapabilityPurposes</c>
