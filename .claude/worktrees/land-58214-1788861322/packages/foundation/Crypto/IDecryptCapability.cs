...
/// <c>Harborline.Api.Foundation.Recovery.EncryptedField</c> values for a
/// specific tenant. Phase 1 reference impl is
/// <c>Harborline.Api.Foundation.Recovery.Crypto.FixedDecryptCapability</c>;
/// macaroon-bound capabilities (ADR 0032) are deferred.
/// </summary>
/// <remarks>
/// W#48 Phase 1.5 PR 2: relocated from
/// <c>Harborline.Api.Foundation.Recovery.Crypto</c> to
/// <c>Harborline.Api.Foundation.Crypto</c> (sibling to <see cref="KeyFingerprint"/>
/// + <see cref="PrincipalId"/>) to break the
/// <c>ui-core → foundation-recovery → kernel-security → ui-core</c>
/// cycle. After this move,
/// <c>Harborline.Api.UICore.Wayfinder.Integrations.IDecryptCapabilityProvider</c>
...
public interface IDecryptCapability
{
    ...
    /// <c>Harborline.Api.Foundation.Recovery.Crypto.FieldDecryptionDeniedException</c>
