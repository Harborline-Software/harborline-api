namespace Harborline.Api.Foundation.PolicyEvaluator;
...
/// <see cref="Harborline.Api.Foundation.Capabilities.Resource"/> is a flat opaque string (<c>Id</c> only) —
...
{
    /// <summary>
    /// Projects this policy resource onto a <see cref="Harborline.Api.Foundation.Capabilities.Resource"/>
    ...
    /// </summary>
    public Harborline.Api.Foundation.Capabilities.Resource ToCapabilityResource()
        => new($"{TypeName}:{Id}");
