...
/// <see cref="Harborline.Api.Kernel.Security.Keys.ISqlCipherKeyDerivation"/>, resolves
/// the team's unopened
/// <see cref="Harborline.Api.Foundation.LocalFirst.Encryption.IEncryptedStore"/> from
...
public interface ITeamStoreActivator
{
    ...
    /// team's unopened <see cref="Harborline.Api.Foundation.LocalFirst.Encryption.IEncryptedStore"/>
