...
using Harborline.Api.Blocks.FinancialAp.Models.Events;
...
public sealed class BillPostingService : IBillPostingService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var bill = await _bills.GetAsync(CurrentTenantId, billId, authority.At, cancellationToken).ConfigureAwait(false);
        if (bill is null)
        ...
        await _bills.UpsertAsync(CurrentTenantId, recorded, authority.At, cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _bills.UpsertAsync(CurrentTenantId, voided, authority.At, cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _bills.UpsertAsync(CurrentTenantId, approved, authority.At, cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _bills.UpsertAsync(CurrentTenantId, disputed, authority.At, cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _bills.UpsertAsync(CurrentTenantId, resolved, authority.At, cancellationToken).ConfigureAwait(false);
    ...
    private void RequireTenant(AuthorizationWriteContext authority)
    {
        if (authority.Tenant != CurrentTenantId)
            throw new ArgumentException("The bill tenant does not match the boundary authority.", nameof(authority));
    }
