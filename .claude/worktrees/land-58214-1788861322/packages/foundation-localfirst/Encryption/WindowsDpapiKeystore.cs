...
/// </summary>
/// <remarks>
/// This keystore is a good default for desktop Harborline nodes. It does not
...
/// </remarks>
public sealed class WindowsDpapiKeystore : IAtomicKeystore
{
    private static readonly byte[] s_entropy = "Harborline.Api.Foundation.LocalFirst.Encryption"u8.ToArray();
        ...
        CancellationToken ct)
    {
        ...
        var sourcePath = GetPathForName(sourceName);
        var destinationPath = GetPathForName(destinationName);
        try
        {
