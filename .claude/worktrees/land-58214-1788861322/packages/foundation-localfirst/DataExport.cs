...
/// <summary>
/// Tenant portability export. Asynchronous: the service queues a job, reports
/// progress, and streams the final package on demand. This contract is not the
/// Data Exchange row-set/mapping surface and is not a backup mechanism.
/// </summary>
