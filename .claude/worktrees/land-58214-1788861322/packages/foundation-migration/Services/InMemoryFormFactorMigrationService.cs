...
using Harborline.Api.Foundation.Migration.Audit;
using Harborline.Api.Kernel.Audit;

namespace Harborline.Api.Foundation.Migration;
...
public sealed class InMemoryFormFactorMigrationService : IFormFactorMigrationService
{
    ...
    public InMemoryFormFactorMigrationService(TimeProvider time)
    {
        _store = null;
        _auditTrail = null;
        _signer = null;
    ...
    public InMemoryFormFactorMigrationService(ISequestrationStore sequestrationStore, TimeProvider time)
    {
