...
namespace Harborline.Api.Blocks.FinancialTax.Seeds;
...
public static class DefaultTaxFormLineMap
{
    ...
    /// (downstream in <c>Harborline.Api.Blocks.Reports.Tax</c>).
    /// </summary>
    /// <param name="chartId">The chart these rows belong to.</param>
    /// <param name="taxYear">IRS form year.</param>
    /// <param name="createdAtUtc">Timestamp for the freshly-stamped rows.</param>
