# NOTICE — Harborline.Api.Blocks.FinancialTax
...
The Harborline implementation is original code, distributed under the
Apache License 2.0. The OFBiz entity-shape pattern is reproduced with
