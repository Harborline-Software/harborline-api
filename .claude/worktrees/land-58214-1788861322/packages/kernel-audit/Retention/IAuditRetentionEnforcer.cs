...
namespace Harborline.Api.Kernel.Audit.Retention;
...
/// <c>Harborline.Api.Foundation.SecurityPolicy</c> resolver).
/// </para>
/// <para>
...
public interface IAuditRetentionEnforcer
{
    ...
    /// <param name="policy">Per-tenant retention policy as resolved upstream by <c>Harborline.Api.Foundation.SecurityPolicy.Retention</c>.</param>
