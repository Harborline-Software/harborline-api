...
namespace Harborline.Api.Blocks.Maintenance.DependencyInjection;

/// <summary>
/// DI extension methods for registering Harborline maintenance-management services.
/// </summary>
public static class MaintenanceServiceCollectionExtensions
{
    ...
    /// Also contributes the open-generic <see cref="IHarborlineLocalizer{T}"/> binding
