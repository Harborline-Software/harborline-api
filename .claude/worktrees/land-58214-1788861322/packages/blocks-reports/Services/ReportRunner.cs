...
namespace Harborline.Api.Blocks.Reports;
...
public sealed class ReportRunner : IReportRunner
{
    ...
    {
        if (result is IReportProvisionalitySource provisionality)
            return (provisionality.IsProvisional, provisionality.Warnings);
