...
/// <see cref="Harborline.Api.Foundation.LocalFirst.Encryption.IEncryptedStore.OpenAsync"/>
...
public interface ISqlCipherKeyDerivation
{
    ...
    /// <c>Harborline.Api.Kernel.Runtime.Teams.TeamId.Value.ToString("D")</c>, i.e. the
    ...
    /// <see cref="Harborline.Api.Foundation.LocalFirst.Encryption.IEncryptedStore.OpenAsync"/>.</returns>
