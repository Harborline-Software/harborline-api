...
/// <c>Harborline.Api.Kernel.Crdt.ICrdtEngine</c> using last-writer-wins-by-IssuedAt-then-IssuedBy
...
/// rejection emits exactly one <c>Harborline.Api.Kernel.Audit.AuditRecord</c> via
...
/// <param name="IssuedAt">Wall-clock time at which the order was issued. ADR 0065 §1 specifies <c>NodaTime.Instant</c>; cohort precedent (W#34 / W#35 / W#40 / W#41) uses <see cref="DateTimeOffset"/> to align with <c>Harborline.Api.Kernel.Audit.AuditRecord.OccurredAt</c> — same choice followed here.</param>
...
/// <param name="AuditRecordId">Reference to the <c>Harborline.Api.Kernel.Audit.AuditRecord</c> emitted at issuance.</param>
