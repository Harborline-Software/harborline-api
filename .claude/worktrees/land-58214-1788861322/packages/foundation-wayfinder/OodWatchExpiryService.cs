...
/// the composition-root clock; tests pass a deterministic fake. R4
/// (XO post-merge council 2026-05-06): the cross-tenant
...
internal sealed class OodWatchExpiryService : BackgroundService
{
    ...
    /// <param name="timeProvider">Required composition-root clock source.</param>
