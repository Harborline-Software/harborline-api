...
/// <param name="CustomerType">ERPNext <c>customer_type</c> — typically <c>"Individual"</c> or <c>"Company"</c>; maps to <see cref="Harborline.Api.Blocks.People.Foundation.Models.PartyKind"/>.</param>
