...
[Migration("20260806010037_WidenSpatialFrameGovernedColumns")]
partial class _20260806010037_WidenSpatialFrameGovernedColumns
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("Harborline.Api.LocalNodeHost.Data.AssetRegistry.SpatialFrameDescriptorRow", b =>
            {
                ...
                b.Property<long>("FrameEpoch")
                    .HasColumnType("INTEGER");

                b.Property<string>("AxisConvention")
                    .IsRequired()
                    .HasMaxLength(128)
                    .HasColumnType("TEXT");
                ...
                b.Property<string>("GeoreferenceJson")
                    .HasColumnType("TEXT");

                b.Property<long>("GrantingHomeEpoch")
                    .HasColumnType("INTEGER");
                ...
                b.HasKey("TenantId", "AnchorId", "FrameCode", "FrameEpoch");
        ...
        modelBuilder.Entity("Harborline.Api.LocalNodeHost.Data.AssetRegistry.SpatialFrameQuarantineRow", b =>
            {
                ...
                b.Property<long>("AttemptedEpoch")
                    .HasColumnType("INTEGER");
                ...
                b.Property<long>("TipEpochAtDetection")
                    .HasColumnType("INTEGER");
